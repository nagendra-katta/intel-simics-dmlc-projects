...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\parameters\\T_parameters.h"
...
struct __devstruct_0test_0p4 {
    conf_object_t *_obj;
};
struct __devstruct_0test_0p5 {
    conf_object_t *_obj;
};
struct __devstruct_0test_0p6 {
    conf_object_t *_obj[11];
};
struct __devstruct_0test_0ps {
...
struct test {
    ...
    struct __devstruct_0test_0p4 p4;
    struct __devstruct_0test_0p5 p5;
    struct __devstruct_0test_0p6 p6;
    struct __devstruct_0test_0ps ps;
};
