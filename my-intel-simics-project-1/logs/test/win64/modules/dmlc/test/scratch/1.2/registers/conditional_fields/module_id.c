...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860280" ";"
	"MOD:" "dml-test-conditional_fields" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:40 2025";
extern void _initialize_T_conditional_fields(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_conditional_fields();
	init_local();
}
