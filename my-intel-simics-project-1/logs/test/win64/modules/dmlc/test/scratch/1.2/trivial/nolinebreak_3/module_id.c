...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860355" ";"
	"MOD:" "dml-test-nolinebreak_3" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:55 2025";
extern void _initialize_T_nolinebreak_3(void);
