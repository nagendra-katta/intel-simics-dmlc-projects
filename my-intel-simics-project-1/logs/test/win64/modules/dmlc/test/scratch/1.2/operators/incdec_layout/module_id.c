...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860267" ";"
	"MOD:" "dml-test-incdec_layout" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:27 2025";
extern void _initialize_T_incdec_layout(void);
