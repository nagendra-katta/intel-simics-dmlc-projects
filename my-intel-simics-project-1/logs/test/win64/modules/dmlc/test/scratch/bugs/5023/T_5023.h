...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\bugs\\5023\\T_5023.h"
...
struct __devstruct_0test_0cpu {
    conf_object_t *obj[128];
    char *port[128];
    simple_interrupt_interface_t const *simple_interrupt[128];
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0cpu cpu;
};
