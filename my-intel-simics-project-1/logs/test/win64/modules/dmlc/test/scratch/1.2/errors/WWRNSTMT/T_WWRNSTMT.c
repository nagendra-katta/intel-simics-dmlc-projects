 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\errors\T_WWRNSTMT.dml
...
#include "T_WWRNSTMT.h"
#include "T_WWRNSTMT-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 122 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\errors\\WWRNSTMT\\T_WWRNSTMT.c"
    _val0 = v3_value;
    return _val0;
}
