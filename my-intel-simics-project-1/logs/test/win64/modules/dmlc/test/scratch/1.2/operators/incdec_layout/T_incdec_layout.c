 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_incdec_layout.dml
...
#include "T_incdec_layout.h"
#include "T_incdec_layout-protos.c"

static conf_object_t *
foo_alloc(conf_class_t *cls)
{
    foo_t *_dev = MM_ZALLOC(1, foo_t);
    _dev->_immediate_after_state = MM_ZALLOC(1, _dml_immediate_after_state_t);
    return &_dev->obj;
}

static lang_void *
foo_init(conf_object_t *_obj)
{
    foo_t *_dev = (foo_t*)_obj;
    ...
    return 0;
    SIM_add_notifier(_obj, Sim_Notify_Object_Delete, _obj, foo_pre_delete, NULL);
    return _obj;
}

static void foo_finalize(conf_object_t *_obj)
{
    foo_t *_dev UNUSED = (foo_t *)_obj;
}

static void foo_objects_finalized(conf_object_t *_obj)
{
    foo_t *_dev UNUSED = (foo_t *)_obj;
...
static void foo_pre_delete(conf_object_t *_subscriber, conf_object_t *_obj, lang_void *_data)
{
    foo_t *_dev = (foo_t *)_obj;
...
static void foo_deinit(conf_object_t *_obj)
{
    foo_t *_dev UNUSED = (foo_t *)_obj;
    _DML_execute_immediate_afters_now(_obj, _dev->_immediate_after_state);
...
static void foo_dealloc(conf_object_t *dev)
{
    MM_FREE(dev);
}
...
static void _init_data_objs(foo_t *_dev)
{
    #line 274 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    _dev->_has_state_callbacks = 0;
    #line 161 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\incdec_layout\\T_incdec_layout.c"
    #line 273 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
/* init */
static bool _DML_M_init(foo_t *_dev)
#line 15 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec_layout.dml"
{
    #line 15 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec_layout.dml"
    {
        ...
        l_t v14_l UNUSED ;
        #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec_layout.dml"
        memset((void *)&v14_l, 0, sizeof(l_t ));
        dml_prechange_uint8_be_t(&v14_l.i, 1, false);
    }
    #line 20 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec_layout.dml"
    return 0;
    #line 20 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec_layout.dml"
...
/* soft_reset */
static bool _DML_M_soft_reset(foo_t *_dev)
#line 1216 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1218 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
...
/* hard_reset */
static bool _DML_M_hard_reset(foo_t *_dev)
#line 1211 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1213 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
...
conf_class_t *
_initialize_T_incdec_layout(void)
{
    ...
    const class_info_t funcs = {
        ...
        .objects_finalized = foo_objects_finalized,
        .dealloc = foo_dealloc,
        .description = "foo device",
    };

    conf_class_t *class = SIM_create_class("foo", &funcs);
    _dev_class = class;
    if (SIM_clear_exception() != SimExc_No_Exception) {
        fprintf(stderr, "Failed to register class foo: %s\n", SIM_last_error());
        return NULL;
    }
...
{
    ht_insert_str(&_id_info_ht, "foo", &_id_infos[0]);
...
static void _init_port_objs(foo_t *_dev)
{
}
static void _init_static_vars(foo_t *_dev)
{
}

// DML serialization functions
static UNUSED bool hard_reset(foo_t *_dev)
{
    return _DML_M_hard_reset(_dev);
}
static UNUSED bool soft_reset(foo_t *_dev)
{
