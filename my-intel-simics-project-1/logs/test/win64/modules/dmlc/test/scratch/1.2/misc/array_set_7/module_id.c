...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860245" ";"
	"MOD:" "dml-test-array_set_7" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:05 2025";
extern void _initialize_T_array_set_7(void);
