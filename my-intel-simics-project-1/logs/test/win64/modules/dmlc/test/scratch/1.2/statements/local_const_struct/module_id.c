...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860302" ";"
	"MOD:" "dml-test-local_const_struct" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:02 2025";
extern void _initialize_T_local_const_struct(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_local_const_struct();
	init_local();
}
