...
#ifndef T_MAP_TARGET_CONNECT_H
#define T_MAP_TARGET_CONNECT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\map_target_connect\\T_map_target_connect.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_map_target_connect-struct.h"
...
typedef _traitref_t map_target_tester;
...
typedef _traitref_t __implicit_init_as_subobj__map_target;
...
struct _map_target {
    ...
    uint32 map_target;
    exception_type_t (*issue)(test_t *arg0, map_target arg1, transaction_t *arg2, uint64 arg3);
};
struct _map_target_tester {
    uint32 address;
    uint32 size;
};
struct _implement {
...
struct _power_on_reset {
    ...
    void  (*power_on_reset)(test_t *arg0, power_on_reset arg1);
    void  (*_default_power_on_reset)(test_t *arg0, power_on_reset arg1);
};
...
struct __hard_reset {
    ...
    void  (*hard_reset)(test_t *arg0, _hard_reset arg1);
    void  (*_default_hard_reset)(test_t *arg0, _hard_reset arg1);
};
...
struct __soft_reset {
    ...
    void  (*soft_reset)(test_t *arg0, _soft_reset arg1);
    void  (*_default_soft_reset)(test_t *arg0, _soft_reset arg1);
};
...
struct ___implicit_init_as_subobj__map_target {
    struct _init_as_subobj init_as_subobj;
    struct _map_target map_target;
};



struct __devstruct_0test_0x_0target_1io_memory {
    void const  *val;
};
struct __devstruct_0test_0x_0target_1memory_space {
    void const  *val;
};
struct __devstruct_0test_0x_0target_1port_space {
    void const  *val;
};
struct __devstruct_0test_0x_0target_0ram {
    void const  *val;
};
struct __devstruct_0test_0x_0target_0rom {
    void const  *val;
};
struct __devstruct_0test_0x_0target_0transaction {
    void const  *val;
};
struct __devstruct_0test_0x_0target_1transaction_translator {
    void const  *val;
};
struct __devstruct_0test_0x_0target_0translator {
    void const  *val;
};
struct __devstruct_0test_0x_0target {
    map_target_t *map_target;
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0x_0target_1io_memory io_memory;
    struct __devstruct_0test_0x_0target_1memory_space memory_space;
    struct __devstruct_0test_0x_0target_1port_space port_space;
    struct __devstruct_0test_0x_0target_0ram ram;
    struct __devstruct_0test_0x_0target_0rom rom;
    struct __devstruct_0test_0x_0target_0transaction transaction;
    struct __devstruct_0test_0x_0target_1transaction_translator transaction_translator;
    struct __devstruct_0test_0x_0target_0translator translator;
};
struct __devstruct_0test_0x {
    uint64 address;
    uint64 size;
    struct __devstruct_0test_0x_0target target;
};
struct __devstruct_0test_0y_0target_1io_memory {
    void const  *val;
};
struct __devstruct_0test_0y_0target_1memory_space {
    void const  *val;
};
struct __devstruct_0test_0y_0target_1port_space {
    void const  *val;
};
struct __devstruct_0test_0y_0target_0ram {
    void const  *val;
};
struct __devstruct_0test_0y_0target_0rom {
    void const  *val;
};
struct __devstruct_0test_0y_0target_0transaction {
    void const  *val;
};
struct __devstruct_0test_0y_0target_1transaction_translator {
    void const  *val;
};
struct __devstruct_0test_0y_0target_0translator {
    void const  *val;
};
struct __devstruct_0test_0y_0target {
    map_target_t *map_target;
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0y_0target_1io_memory io_memory;
    struct __devstruct_0test_0y_0target_1memory_space memory_space;
    struct __devstruct_0test_0y_0target_1port_space port_space;
    struct __devstruct_0test_0y_0target_0ram ram;
    struct __devstruct_0test_0y_0target_0rom rom;
    struct __devstruct_0test_0y_0target_0transaction transaction;
    struct __devstruct_0test_0y_0target_1transaction_translator transaction_translator;
    struct __devstruct_0test_0y_0target_0translator translator;
};
struct __devstruct_0test_0y {
    uint64 address;
    uint64 size;
    struct __devstruct_0test_0y_0target target;
};
struct __devstruct_0test_0z_0r {
    uint64 val;
};
struct __devstruct_0test_0z {
    conf_object_t *_obj;
    ...
    struct __devstruct_0test_0z_0r r;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0x x;
    struct __devstruct_0test_0y y;
    struct __devstruct_0test_0z z;
};
...
#endif /* not T_MAP_TARGET_CONNECT_H */
