...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\internal\\index\\T_index.h"
...
struct __devstruct_0test_0b_0gma {
    uint32 r;
};
...
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_0gma gma;
    struct __devstruct_0test_0b_0r r;
    uint32 ra[2];
    uint32 rma[2][2];
};
struct __devstruct_0test_0ba_0gma {
    uint32 r[4];
};
struct __devstruct_0test_0ba_0r {
    uint32 __DMLfield[4];
    uint8 f[4][2][2];
};
struct __devstruct_0test_0ba {
    conf_object_t *_obj[4];
    _callback_vect_t _after_read_callbacks[4];
    _callback_vect_t _after_write_callbacks[4];
    _callback_vect_t _before_read_callbacks[4];
    _callback_vect_t _before_write_callbacks[4];
    conf_object_t *_cached_bank_obj[4];
    _connection_vect_t _connections[4];
    struct __devstruct_0test_0ba_0gma gma;
    struct __devstruct_0test_0ba_0r r;
    uint32 ra[4][2];
    uint32 rma[4][2][2];
};
struct test {
