...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860518" ";"
	"MOD:" "dml-test-multidecls" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:38 2025";
extern void _initialize_T_multidecls(void);
