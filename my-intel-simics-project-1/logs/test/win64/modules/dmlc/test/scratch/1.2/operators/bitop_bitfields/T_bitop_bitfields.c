 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_bitop_bitfields.dml
...
#include "T_bitop_bitfields.h"
#include "T_bitop_bitfields-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 12 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                    {
                        uint8 v11_bf UNUSED  = 124;
                        uint8 v11_i1 UNUSED  = 0;
                        uint8 v11_i2 UNUSED  = 0;
                        uint8 v11_i3 UNUSED  = 5;
                        uint8 v11_i4 UNUSED  = 5;
                        v10_ok = 1;
                        #line 20 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_i1 = ~v11_bf;
                        v10_ok = v10_ok && v11_i1 == 131;
                        #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_i1 = 5 & v11_bf;
                        v11_i2 = v11_bf & 5;
                        v11_i3 = v11_i3 & v11_bf;
                        v11_bf = v11_bf & v11_i4;
                        v11_i4 = v11_bf;
                        #line 32 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v10_ok = (((v10_ok && v11_i1 == 4) && v11_i2 == 4) && v11_i3 == 4) && v11_i4 == 4;
                        #line 34 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_bf = 124;
                        v11_i3 = ((v11_i4 = 5), (v11_i4));
                        v11_i1 = 5 | v11_bf;
                        v11_i2 = v11_bf | 5;
                        v11_i3 = v11_i3 | v11_bf;
                        v11_bf = v11_bf | v11_i4;
                        v11_i4 = v11_bf;
                        #line 45 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v10_ok = (((v10_ok && v11_i1 == 125) && v11_i2 == 125) && v11_i3 == 125) && v11_i4 == 125;
                        #line 47 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_bf = 124;
                        v11_i3 = ((v11_i4 = 5), (v11_i4));
                        v11_i1 = 5 ^ v11_bf;
                        ...
                        v11_i4 = v11_bf;
                        #line 58 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v10_ok = (((v10_ok && v11_i1 == 121) && v11_i2 == 121) && v11_i3 == 121) && v11_i4 == 121;
                        #line 60 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_bf = 124;
                        v11_i1 = 5;
                        v11_i2 = (uint64 )v11_bf << v11_i1;
                        v10_ok = v10_ok && v11_i2 == 128;
                        #line 65 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v11_i2 = v11_bf >> v11_i1;
                        v10_ok = v10_ok && v11_i2 == 3;
                        #line 68 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                        v10_ok = v10_ok && ((uint8 )(v11_bf >> 1 & 63)) == 62;
                    }
                    #line 12 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_bitop_bitfields.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 171 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\bitop_bitfields\\T_bitop_bitfields.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_bitop_bitfields(void)
{
