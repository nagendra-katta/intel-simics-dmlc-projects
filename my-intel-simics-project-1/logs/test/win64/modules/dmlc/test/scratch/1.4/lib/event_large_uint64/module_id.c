...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860434" ";"
	"MOD:" "dml-test-event_large_uint64" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:14 2025";
extern void _initialize_T_event_large_uint64(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_event_large_uint64();
	init_local();
}
