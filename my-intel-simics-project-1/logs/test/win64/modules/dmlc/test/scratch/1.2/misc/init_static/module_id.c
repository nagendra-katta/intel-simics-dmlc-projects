...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860247" ";"
	"MOD:" "dml-test-init_static" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:07 2025";
extern void _initialize_T_init_static(void);
