...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860348" ";"
	"MOD:" "dml-test-loggroup_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:48 2025";
extern void _initialize_T_loggroup_1(void);
