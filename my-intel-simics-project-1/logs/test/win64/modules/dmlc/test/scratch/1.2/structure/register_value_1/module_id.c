...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860328" ";"
	"MOD:" "dml-test-register_value_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:28 2025";
extern void _initialize_T_register_value_1(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_register_value_1();
	init_local();
}
