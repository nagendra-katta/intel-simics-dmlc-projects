 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_sizeof.dml
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                    {
                        ...
                        uint32 *v11_ip UNUSED  = NULL;
                        uint8 *v11_bp UNUSED  = NULL;
                        uint32 v11_y UNUSED  = 0;
                        uint32 v11_z UNUSED  = 0;
                        uint48_be_t v11_be UNUSED ;
                        #line 20 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                        memset((void *)&v11_be, 0, sizeof(uint48_be_t ));
                        uint56_le_t v11_le UNUSED ;
                        #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                        memset((void *)&v11_le, 0, sizeof(uint56_le_t ));
                        #line 39 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                        v10_ok = ((((((((((((((((uint64 )sizeof(v11_x) == 4 && (uint64 )sizeof(v11_y) == 4) && (uint64 )sizeof(v11_z) == 4) && (uint64 )sizeof(v11_be) == 6) && (uint64 )sizeof(v11_le) == 7) && (uint64 )sizeof(v11_x) == 4) && (uint64 )sizeof(x ) == 1) && (uint64 )sizeof(t) == 4) && (uint64 )sizeof(_dev->x) == 2) && (uint64 )sizeof(_dev->x) == 2) && (uint64 )sizeof(uint32 ) == 4) && (uint64 )sizeof(uint32 ) == 4) && (uint64 )sizeof(uint32 *) == (uint64 )sizeof(uint8 *)) && (uint64 )sizeof(t ) == 4) && (uint64 )sizeof(t ) == 4) && (uint64 )sizeof(v11_ip) == (uint64 )sizeof(v11_bp)) && (uint64 )sizeof(size_t ) == (uint64 )sizeof(void  *);
                        #line 43 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                        SIM_log_info(1, &_dev->obj, 0, "%zd %zd %zd %zd", sizeof(v11_x), sizeof(_dev->x), sizeof(uint32 ), sizeof(t ));
                        #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                        v11_x = sizeof(((v10_ok = 0), (v10_ok)));
                    }
                    #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 141 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\sizeof\\T_sizeof.c"
    _val0 = v3_value;
    return _val0;
}
