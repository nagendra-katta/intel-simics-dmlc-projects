 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_equal_booleans_3.dml
...
#include "T_equal_booleans_3.h"
#include "T_equal_booleans_3-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_equal_booleans_3.dml"
                    bool v10_b UNUSED  = 0;
                    if (SIM_object_is_configured(&_dev->obj) == 1)
                    v10_b = 1;
                    else
                    v10_b = 0;
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_equal_booleans_3.dml"
    ...
    #line 125 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\equal_booleans_3\\T_equal_booleans_3.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_equal_booleans_3(void)
{
