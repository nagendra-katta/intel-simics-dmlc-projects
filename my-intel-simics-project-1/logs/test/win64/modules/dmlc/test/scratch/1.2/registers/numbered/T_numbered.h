...
struct __devstruct_0test_0hole {
    conf_object_t *_obj;
...
struct __devstruct_0test_0rw_0g1_0h {
    uint32 r[4][2][2];
};
struct __devstruct_0test_0rw_0g1 {
    struct __devstruct_0test_0rw_0g1_0h h;
    uint32 r4[4];
};
struct __devstruct_0test_0rw_0g2 {
    uint32 r1;
};
struct __devstruct_0test_0rw {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0rw_0g1 g1;
    struct __devstruct_0test_0rw_0g2 g2;
    uint32 r[2][2];
    uint32 r1;
    uint32 r2;
    uint32 r3[4];
...
struct test {
    ...
    struct __devstruct_0test_0hole hole;
    struct __devstruct_0test_0ro ro;
    struct __devstruct_0test_0rw rw;
};
