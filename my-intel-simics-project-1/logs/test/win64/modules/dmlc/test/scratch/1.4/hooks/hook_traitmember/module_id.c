...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860407" ";"
	"MOD:" "dml-test-hook_traitmember" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:47 2025";
extern void _initialize_T_hook_traitmember(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_hook_traitmember();
	init_local();
}
