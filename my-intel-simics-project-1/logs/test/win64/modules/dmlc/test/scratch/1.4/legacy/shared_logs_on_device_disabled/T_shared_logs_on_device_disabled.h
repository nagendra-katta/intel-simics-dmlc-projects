...
#ifndef T_SHARED_LOGS_ON_DEVICE_DISABLED_H
#define T_SHARED_LOGS_ON_DEVICE_DISABLED_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\legacy\\shared_logs_on_device_disabled\\T_shared_logs_on_device_disabled.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_shared_logs_on_device_disabled-struct.h"
...
typedef _traitref_t __implicit_device__t;
typedef _traitref_t __implicit_group__t;
typedef _traitref_t __implicit_subdevice__t;
...
struct ___implicit_device__t {
    struct _device device;
    struct _t t;
};
struct ___implicit_group__t {
    struct _group group;
    struct _t t;
};
struct ___implicit_subdevice__t {
    struct _subdevice subdevice;
    struct _t t;
};



struct __devstruct_0test_0g_0s_0c_0s {
    conf_object_t *_obj[3LL][5LL][7LL];
    conf_object_t *_cached_port_obj[3LL][5LL][7LL];
};
struct __devstruct_0test_0g_0s_0c {
    struct __devstruct_0test_0g_0s_0c_0s s;
};
struct __devstruct_0test_0g_0s {
    conf_object_t *_obj[3LL];
    conf_object_t *_cached_port_obj[3LL];
    struct __devstruct_0test_0g_0s_0c c;
};
...
#endif /* not T_SHARED_LOGS_ON_DEVICE_DISABLED_H */
