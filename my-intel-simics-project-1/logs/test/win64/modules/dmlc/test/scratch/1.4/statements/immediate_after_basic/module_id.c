...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860495" ";"
	"MOD:" "dml-test-immediate_after_basic" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:15 2025";
extern void _initialize_T_immediate_after_basic(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_immediate_after_basic();
	init_local();
}
