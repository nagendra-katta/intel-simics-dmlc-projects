...
#ifndef T_WCONFIDENTIAL_H
#define T_WCONFIDENTIAL_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\internal\\WCONFIDENTIAL\\T_WCONFIDENTIAL.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_WCONFIDENTIAL-struct.h"
...
struct __devstruct_0test_0b_0secret2 {
    uint16 __DMLfield;
    uint8 f;
};
struct __devstruct_0test_0b {
    ...
    uint16 secret1;
    struct __devstruct_0test_0b_0secret2 secret2;
};
struct test {
    conf_object_t obj;
