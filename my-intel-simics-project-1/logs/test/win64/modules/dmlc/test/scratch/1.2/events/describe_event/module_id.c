...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860203" ";"
	"MOD:" "dml-test-describe_event" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:23 2025";
extern void _initialize_T_describe_event(void);
