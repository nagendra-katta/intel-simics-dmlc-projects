...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860244" ";"
	"MOD:" "dml-test-attr_lvalue" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:04 2025";
extern void _initialize_T_attr_lvalue(void);
