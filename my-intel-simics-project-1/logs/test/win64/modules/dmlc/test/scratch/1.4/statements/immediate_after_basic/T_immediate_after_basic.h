...
#ifndef T_IMMEDIATE_AFTER_BASIC_H
#define T_IMMEDIATE_AFTER_BASIC_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\statements\\immediate_after_basic\\T_immediate_after_basic.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_immediate_after_basic-struct.h"
...
struct _immediate_after_3_args {
    int (*arr)[5LL][7LL];
    int x;
};
struct _immediate_after_5_args {
    int id;
};
...
#endif /* not T_IMMEDIATE_AFTER_BASIC_H */
