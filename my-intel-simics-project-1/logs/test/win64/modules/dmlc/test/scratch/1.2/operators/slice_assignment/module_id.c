...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860274" ";"
	"MOD:" "dml-test-slice_assignment" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:34 2025";
extern void _initialize_T_slice_assignment(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_slice_assignment();
	init_local();
}
