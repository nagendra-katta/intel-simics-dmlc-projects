...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860426" ";"
	"MOD:" "dml-test-port_proxy_ifaces_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:06 2025";
extern void _initialize_T_port_proxy_ifaces_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_port_proxy_ifaces_enabled();
	init_local();
}
