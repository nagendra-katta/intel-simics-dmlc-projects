 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\hooks\T_asynchronous_send.dml
...
#include "T_asynchronous_send.h"
#include "T_asynchronous_send-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 111 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\asynchronous_send\\T_asynchronous_send.c"
...
static void test_deinit(conf_object_t *_obj)
{
    ...
    for (uint32 _i0 = 0; _i0 < 3; _i0++) {
        for (uint32 _i1 = 0; _i1 < 5; _i1++) {
            _DML_free_hook_queue(&_dev->h2[_i0][_i1].queue);
        }
    }
...
static const _id_info_t _hook_id_infos[2] UNUSED = {
    {"h1", NULL, 0, 1},
    {"h2[%u][%u]", (const uint32 []) {3, 5}, 2, 2}
};
static ht_str_table_t _hook_id_info_ht UNUSED = HT_STR_NULL(false);
static void * const _object_vtables[3] UNUSED = {(&_tr__dev__device.object), (&_tr_setup__read_only_attr.pseudo_attr.attribute._conf_attribute.object), (&_tr_test__read_only_attr.pseudo_attr.attribute._conf_attribute.object)};
...
/* do_test */
static void  _DML_M_do_test(test_t *_dev)
#line 44 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
{
    DML_ASSERT("C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\hooks\\T_asynchronous_send.dml", 45, (int64 )_dev->count == 1LL && (int64 )_dev->storage == 6LL);
    int v541_tmp0 UNUSED  = (int32 )0LL;
    #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    {
        #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
        _dev->storage = v541_tmp0;
        #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    }
    #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    {
        #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
        _dev->count = v541_tmp0;
        #line 46 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    }
    _DML_TM_object__cancel_after(_dev, UPCAST(((device) {(&_tr__dev__device), ((_identity_t) {.id = 1, .encoded_index = 0})}), device, object));
    return;
    #line 48 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
}
#line 3504 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\asynchronous_send\\T_asynchronous_send.c"
...
{
    #line 31 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    _DML_post_immediate_after(&_dev->obj, _dev->_immediate_after_state, _immediate_after_0_callback, NULL, 0, (_hookref_t [1LL]){((_hookref_t) {.id = 1, .encoded_index = 0})}, sizeof(_hookref_t ), NULL, 0);
    _DML_post_immediate_after(&_dev->obj, _dev->_immediate_after_state, _immediate_after_1_callback, NULL, 0, &(struct _immediate_after_1_args ){ ((_hookref_t) {.id = 2, .encoded_index = 7}), { &_dev->storage, (int32 )6LL } }, sizeof(struct _immediate_after_1_args ), NULL, 0);
    #line 34 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    { _DML_post_immediate_after(&_dev->obj, _dev->_immediate_after_state, _immediate_after_0_callback, NULL, 0, (_hookref_t [1LL]){((_hookref_t) {.id = 1, .encoded_index = 0})}, sizeof(_hookref_t ), (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    { _DML_post_immediate_after(&_dev->obj, _dev->_immediate_after_state, _immediate_after_1_callback, NULL, 0, (struct _immediate_after_1_args [1LL]){{ ((_hookref_t) {.id = 2, .encoded_index = 7}), { &_dev->storage, (int32 )-4LL } }}, sizeof(struct _immediate_after_1_args ), (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    #line 37 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    _DML_TM_object__cancel_after(_dev, UPCAST(((device) {(&_tr__dev__device), ((_identity_t) {.id = 1, .encoded_index = 0})}), device, object));
    #line 39 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
    { _DML_attach_callback_to_hook(&_dev->h1, &_after_on_hook_infos[0], NULL, 0, NULL, (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    { _DML_attach_callback_to_hook(&_dev->h2[1LL][2LL], &_after_on_hook_infos[1], NULL, 0, NULL, (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    DML_ASSERT("C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\hooks\\T_asynchronous_send.dml", 41, (int64 )_dev->count == 0LL && (int64 )_dev->storage == 0LL);
    return;
    #line 42 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
}
#line 3534 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\asynchronous_send\\T_asynchronous_send.c"
...
/* store */
static void  _DML_M_store(test_t *_dev, int *target, int x)
#line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
{
    {
        #line 24 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_asynchronous_send.dml"
...
static const _dml_hook_aux_info_t _hook_aux_infos[2] UNUSED = {
    ...
    {offsetof(test_t, h2[0ULL][0ULL]), 1, 2}
};
conf_class_t *
_initialize_T_asynchronous_send(void)
{
...
static const _vtable_list_t _each___conf_attribute[2] UNUSED = {
    {&_tr_setup__read_only_attr.pseudo_attr.attribute._conf_attribute, 1, 2},
    {&_tr_test__read_only_attr.pseudo_attr.attribute._conf_attribute, 1, 3}
};
...
static void _after_on_hook_1_callback(conf_object_t *_obj, const uint32 *indices, const void *_args, const void *_msg)
{
    ...
    _DML_M_store(_dev, msg->comp0, msg->comp1);
}
...
static set_error_t _after_on_hook_1_args_deserializer(attr_value_t val, void *_out)
{
    ...
    if (SIM_attr_is_list(val) && (int64 )SIM_attr_list_size(val) == 2ULL)
    {
        ...
        if (!SIM_attr_is_nil(_imm_attr))
        {
            ...
            SIM_attribute_error("expected list item 0 to be nil during deserialization of arguments to store");
            goto _exit;
        }
        {
        ...
        {
            _success = Sim_Set_Illegal_Type;
            SIM_attribute_error("expected list item 1 to be nil during deserialization of arguments to store");
            goto _exit;
        }
    }
    else
    {
        _success = Sim_Set_Illegal_Type;
        SIM_attribute_error("expected list of size 2 during deserialization of arguments to store");
        goto _exit;
    }
    _exit:
    return _success;
...
static const _dml_after_on_hook_info_t _after_on_hook_infos[] UNUSED = {
    {"('inc', ())", _after_on_hook_0_callback, NULL, NULL, 0, 1},
    {"('store', (0, 1))", _after_on_hook_1_callback, _after_on_hook_1_args_serializer, _after_on_hook_1_args_deserializer, 0, 1}
};
...
static void _cancel_simple_events(conf_object_t *_obj, _identity_t _domain)
{
    ...
    for (uint32 _i0 = 0; _i0 < 3; _i0++) {
        for (uint32 _i1 = 0; _i1 < 5; _i1++) {
            _DML_cancel_afters_in_hook_queue(&_dev->h2[_i0][_i1].queue, _domain, 0);
        }
    }
