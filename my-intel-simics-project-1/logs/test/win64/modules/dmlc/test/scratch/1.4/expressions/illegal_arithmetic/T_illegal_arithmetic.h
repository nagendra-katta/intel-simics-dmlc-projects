...
#ifndef T_ILLEGAL_ARITHMETIC_H
#define T_ILLEGAL_ARITHMETIC_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\expressions\\illegal_arithmetic\\T_illegal_arithmetic.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_illegal_arithmetic-struct.h"
...
struct __devstruct_0test_1not_negative {
    int64 val;
};
struct __devstruct_0test_1not_zero {
    uint64 val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1not_negative not_negative;
    struct __devstruct_0test_1not_zero not_zero;
};
...
#endif /* not T_ILLEGAL_ARITHMETIC_H */
