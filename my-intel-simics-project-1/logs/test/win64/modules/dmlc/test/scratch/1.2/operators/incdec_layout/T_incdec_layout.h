...
#ifndef T_INCDEC_LAYOUT_H
#define T_INCDEC_LAYOUT_H

#define DML_PREFIX(x) foo_##x
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\incdec_layout\\T_incdec_layout.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_incdec_layout-struct.h"
...
// which saves space
STATIC_ASSERT(sizeof(struct foo) <= UINT32_MAX);
static const uint64 Register_Read UNUSED = 1ULL;
static const uint64 Register_Write UNUSED = 2ULL;

void hard_reset_foo(foo_t *_obj);
void soft_reset_foo(foo_t *_obj);

#endif /* not T_INCDEC_LAYOUT_H */
