...
#ifndef T_TRAIT_DIAMOND_H
#define T_TRAIT_DIAMOND_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\trait_diamond\\T_trait_diamond.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_trait_diamond-struct.h"

typedef _traitref_t abc;
typedef _traitref_t ta;
typedef _traitref_t tb;
typedef _traitref_t tc;
typedef _traitref_t t;
typedef _traitref_t d;
typedef _traitref_t object;
typedef _traitref_t __implicit_d__t;
typedef conf_object_t processor_t;



struct _abc {
    int (*a)(test_t *arg0, abc arg1);
    int (*b)(test_t *arg0, abc arg1);
    int (*c)(test_t *arg0, abc arg1);
};
struct _ta {
    struct _abc abc;
    int (*d)(test_t *arg0, ta arg1);
};
struct _tb {
    struct _abc abc;
    int *extra;
