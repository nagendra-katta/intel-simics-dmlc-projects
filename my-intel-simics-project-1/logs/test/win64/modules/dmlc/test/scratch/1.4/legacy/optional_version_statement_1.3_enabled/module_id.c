...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860421" ";"
	"MOD:" "dml-test-optional_version_statement_1.3_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:01 2025";
extern void _initialize_T_optional_version_statement_1_3_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_optional_version_statement_1_3_enabled();
	init_local();
}
