...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860305" ";"
	"MOD:" "dml-test-log_variable_width" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:05 2025";
extern void _initialize_T_log_variable_width(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_log_variable_width();
	init_local();
}
