...
#ifndef T_BITFIELDS_ENDIAN_H
#define T_BITFIELDS_ENDIAN_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\bitfields_endian\\T_bitfields_endian.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_bitfields_endian-struct.h"

typedef _traitref_t object;
typedef struct be_layout be_layout;
typedef uint32 bitfield_24;

typedef uint32 bitfield_32;

struct be_layout {
    uint24_be_t member_24;
    uint32_be_t member_32;
};
...
#endif /* not T_BITFIELDS_ENDIAN_H */
