 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\errors\T_EVARPARAM_5.dml
...
#include "T_EVARPARAM_5.h"
#include "T_EVARPARAM_5-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 122 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\errors\\EVARPARAM_5\\T_EVARPARAM_5.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_EVARPARAM_5(void)
{
