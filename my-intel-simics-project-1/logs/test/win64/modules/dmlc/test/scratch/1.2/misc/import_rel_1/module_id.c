...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860246" ";"
	"MOD:" "dml-test-import_rel_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:06 2025";
extern void _initialize_T_import_rel_1(void);
