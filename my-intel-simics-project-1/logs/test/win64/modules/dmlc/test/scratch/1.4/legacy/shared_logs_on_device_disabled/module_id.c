...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860427" ";"
	"MOD:" "dml-test-shared_logs_on_device_disabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:07 2025";
extern void _initialize_T_shared_logs_on_device_disabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_shared_logs_on_device_disabled();
	init_local();
}
