...
#ifndef T_OBSCUREABLE_H
#define T_OBSCUREABLE_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\obscureable\\T_obscureable.h"
...
typedef _traitref_t reg;
typedef _traitref_t secret_reg;
typedef _traitref_t public_reg;
...
typedef _traitref_t __implicit_bank__obscureable;
typedef _traitref_t __implicit__read_field___write_field__public_field;
typedef _traitref_t __implicit__read_field___write_field__secret_field;
...
struct _fie {
    struct _field field;
    struct _obscureable obscureable;
};
struct _read_field {
...
struct ___implicit_bank__obscureable {
    struct _bank bank;
    struct _obscureable obscureable;
};
struct ___implicit__read_field___write_field__public_field {
    struct __read_field _read_field;
    struct __write_field _write_field;
    struct _public_field public_field;
};
struct ___implicit__read_field___write_field__secret_field {
    struct __read_field _read_field;
    struct __write_field _write_field;
    struct _secret_field secret_field;
};
...
struct __devstruct_0test_1secret_bank1 {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct __devstruct_0test_1test_bank_0r {
    uint64 val;
};
struct __devstruct_0test_1test_bank_0r6 {
    uint64 val;
};
struct __devstruct_0test_1test_bank {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_1test_bank_0r r;
    struct __devstruct_0test_1test_bank_0r6 r6;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1secret_bank1 secret_bank1;
    struct __devstruct_0test_1test_bank test_bank;
};
