...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860500" ";"
	"MOD:" "dml-test-throwing_initializers" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:20 2025";
extern void _initialize_T_throwing_initializers(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_throwing_initializers();
	init_local();
}
