...
#ifndef T_TRAIT_DIAMOND_DEFAULT_H
#define T_TRAIT_DIAMOND_DEFAULT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\trait_diamond_default\\T_trait_diamond_default.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_trait_diamond_default-struct.h"

typedef _traitref_t AA;
typedef _traitref_t BB;
typedef _traitref_t CC;
...
typedef _traitref_t __implicit_BB__CC;


struct _AA {
    void  (*b)(test_t *arg0, AA arg1);
    void  (*c)(test_t *arg0, AA arg1);
};
struct _BB {
    struct _AA AA;
    void  (*from_b_vtable)(test_t *arg0, BB arg1);
};
struct _CC {
    struct _AA AA;
    void  (*from_c_vtable)(test_t *arg0, CC arg1);
};
struct _name {
    char const **name;
};
...
#endif /* not T_TRAIT_DIAMOND_DEFAULT_H */
