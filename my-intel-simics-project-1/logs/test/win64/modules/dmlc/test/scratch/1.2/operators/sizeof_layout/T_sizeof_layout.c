 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_sizeof_layout.dml
...
#include "T_sizeof_layout.h"
#include "T_sizeof_layout-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof_layout.dml"
                    {
                        foo_t v11_foo UNUSED ;
                        #line 22 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof_layout.dml"
                        memset((void *)&v11_foo, 0, sizeof(foo_t ));
                        bar_t v11_arry[8] UNUSED ;
                        #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof_layout.dml"
                        memset((void *)&v11_arry, 0, sizeof(bar_t [8]));
                        #line 30 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof_layout.dml"
                        v10_ok = (((((uint64 )sizeof(v11_foo.bar) == 16 && (uint64 )sizeof(v11_foo.bar) == 16) && (uint64 )sizeof(bar_t) == 16) && (uint64 )sizeof(bar_t ) == 16) && (uint64 )sizeof(bar_t ) == 16) && (uint64 )sizeof(v11_arry) == 128;
                    }
                    #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_sizeof_layout.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 132 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\sizeof_layout\\T_sizeof_layout.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_sizeof_layout(void)
{
