...
#ifndef T_SAVED_STATEMENT_H
#define T_SAVED_STATEMENT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_statement\\T_saved_statement.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_saved_statement-struct.h"
...
struct test {
    conf_object_t obj;
    int static0_v;
    int static1_v[4ULL][3ULL];
    int static2_s[4ULL][3ULL];
    int static3_v[4ULL];
    int static4_s[4ULL];
    int static5_with_init;
    int static6_without_init;
