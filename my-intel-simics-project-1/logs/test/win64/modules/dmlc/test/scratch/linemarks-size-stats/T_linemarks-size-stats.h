...
#ifndef T_LINEMARKS_SIZE_STATS_H
#define T_LINEMARKS_SIZE_STATS_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\linemarks-size-stats\\T_linemarks-size-stats.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_linemarks-size-stats-struct.h"
...
struct _u {
    void  (*s_m)(test_t *arg0, u arg1);
};
struct _memo_t__s_memo_startup {
    int p__out0;
    bool p__out1;
    float p__out2;
    int8 ran;
...
struct _t {
    struct _u u;
    struct _memo_t__s_memo_startup *_memo_outs_s_memo_startup;
};
struct _set_val {
...
#endif /* not T_LINEMARKS_SIZE_STATS_H */
