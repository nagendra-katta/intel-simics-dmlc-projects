 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\misc\T_init_local.dml
...
#include "T_init_local.h"
#include "T_init_local-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        #line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        int v11_simple_array[4] UNUSED  = {0, 0x100, 128, 0x1000};
                        #line 15 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = ((v11_simple_array[0] == 0 && v11_simple_array[1] == 0x100) && v11_simple_array[2] == 128) && v11_simple_array[3] == 0x1000;
                        if (!v10_ok)
                        goto exit4;
                        #line 20 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        int v11_d2_array[2][4] UNUSED  = {{1, 2, 3, 4}, {5, 6, 7, 8}};
                        #line 30 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = ((((((v11_d2_array[0][0] == 1 && v11_d2_array[0][1] == 2) && v11_d2_array[0][2] == 3) && v11_d2_array[0][3] == 4) && v11_d2_array[1][0] == 5) && v11_d2_array[1][1] == 6) && v11_d2_array[1][2] == 7) && v11_d2_array[1][3] == 8;
                        if (!v10_ok)
                        goto exit4;
                        #line 35 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        char const *v11_str_array[2] UNUSED  = {"A", "B"};
                        #line 40 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = ((v11_str_array[0][0] == 65 && v11_str_array[0][1] == 0) && v11_str_array[1][0] == 66) && v11_str_array[1][1] == 0;
                        if (!v10_ok)
                        goto exit4;
                        #line 45 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        ...
                        #line 45 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        struct _anon_struct_0 v11_simple_struct UNUSED  = {42, 1};
                        #line 49 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = v11_simple_struct.i == 42 && v11_simple_struct.b == 1;
                        if (!v10_ok)
                        goto exit4;
                        #line 54 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        ...
                        #line 54 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        struct _anon_struct_1 v11_a_struct_array[2] UNUSED  = {{11}, {12}};
                        #line 57 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = v11_a_struct_array[0].i == 11 && v11_a_struct_array[1].i == 12;
                        if (!v10_ok)
                        goto exit4;
                        #line 62 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        ...
                        #line 62 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        struct _anon_struct_2 v11_b_struct UNUSED  = {{9, 10}};
                        #line 65 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = v11_b_struct.a[0] == 9 && v11_b_struct.a[1] == 10;
                        if (!v10_ok)
                        goto exit4;
                        #line 70 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        uint32 v11_bf UNUSED  = 0x401234cc;
                        #line 75 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        uint32 v11_bf_v UNUSED  = v11_bf;
                        #line 79 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        v10_ok = ((((uint8 )(v11_bf >> 29 & 7)) == 2 && ((uint16 )((uint16 )(v11_bf >> 8 & 0xffff))) == 0x1234) && ((uint8 )((uint8 )(v11_bf & 255))) == 204) && v11_bf_v == 0x401234cc;
                        if (!v10_ok)
                        goto exit4;
                        #line 84 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
                        int v11_i UNUSED  = 3;
                        int v11_nonconst_array[1] UNUSED  = {v11_i};
                        v10_ok = v11_nonconst_array[0] == v11_i;
                    }
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
                exit4: ;
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_local.dml"
    ...
    #line 190 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\init_local\\T_init_local.c"
    _val0 = v3_value;
    return _val0;
}
