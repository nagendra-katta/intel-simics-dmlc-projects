...
#ifndef T_ARRAY_REF_H
#define T_ARRAY_REF_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\array_ref\\T_array_ref.h"
...
struct __devstruct_0test_0a_0g {
    uint32 bar[1][2][2];
    uint32 foo[1];
};
struct __devstruct_0test_0a {
    ...
    struct __devstruct_0test_0a_0g g;
};
