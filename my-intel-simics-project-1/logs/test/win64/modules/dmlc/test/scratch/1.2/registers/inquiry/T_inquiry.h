...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\registers\\inquiry\\T_inquiry.h"
...
struct test {
    ...
    bool after_read_called;
    bool after_set_called;
    bool after_write_called;
    struct __devstruct_0test_0b b;
    bool before_read_called;
    bool before_set_called;
    bool before_write_called;
    uint64 write_val;
};
