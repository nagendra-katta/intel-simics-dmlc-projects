 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\serialize\T_saved_failure.dml
...
#include "T_saved_failure.h"
#include "T_saved_failure-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 111 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_failure\\T_saved_failure.c"
...
static void _init_data_objs(test_t *_dev)
{
    ...
    #line 181 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_failure\\T_saved_failure.c"
    #line 10 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\serialize\\\\T_saved_failure.dml"
    memcpy((void *)_dev->g.saved_objects[0LL], (object [2LL]){((object) {(&_tr__dev__device.object), ((_identity_t) {.id = 1, .encoded_index = 0})}), ((object) {(&_tr_g__group.object), ((_identity_t) {.id = 2, .encoded_index = 0})})}, sizeof _dev->g.saved_objects[0LL]);
    #line 10 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\serialize\\\\T_saved_failure.dml"
    memcpy((void *)_dev->g.saved_objects[1LL], (object [2LL]){((object) {(&_tr__dev__device.object), ((_identity_t) {.id = 1, .encoded_index = 0})}), ((object) {(&_tr_g__group.object), ((_identity_t) {.id = 2, .encoded_index = 1})})}, sizeof _dev->g.saved_objects[1LL]);
    #line 186 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_failure\\T_saved_failure.c"
}
...
conf_class_t *
_initialize_T_saved_failure(void)
{
    ...
    _register_events(class);
    {
        const struct {
          ...
          const char *type;
            ...
            {"g_saved_objects", "[[[s[i*]]{2}]{2}]"},
        };
        static const _saved_userdata_t saved_userdata[1] = {
            {offsetof(test_t, g.saved_objects[0ULL]), 1, _tuple0_dims_g_saved_objects, _tuple1_strides_g_saved_objects, DML_deserialize_A2Tobject, DML_serialize_A2T},
        };
...
attr_value_t DML_serialize_A2T(void const  *_in) {
    object (*in)[2LL] = (object (*)[2LL])_in;
    attr_value_t out;
    {
        out = _serialize_array(&(*in), sizeof(object ), (const uint32 []) { 2LL }, 1LL, DML_serialize_T);
    }
    return out;
}
...
set_error_t DML_deserialize_A2Tobject(attr_value_t in, void  *_out) {
    object (*out)[2LL] = (object (*)[2LL])_out;
    set_error_t _success UNUSED = Sim_Set_Ok;
    {
        set_error_t _sub_success;
        {
            _sub_success = _deserialize_array(in, &(*out), sizeof(object ), (const uint32 []) { 2LL }, 1LL, DML_deserialize_Tobject, 0);
        }
        if (_sub_success != Sim_Set_Ok)
        {
            _success = _sub_success;
...
static const uint32 _tuple0_dims_g_saved_objects[1] UNUSED = {2};
static const uint32 _tuple1_strides_g_saved_objects[1] UNUSED = {sizeof(object [2LL])};
