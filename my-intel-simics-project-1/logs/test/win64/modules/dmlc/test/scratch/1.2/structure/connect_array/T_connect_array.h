...
#ifndef T_CONNECT_ARRAY_H
#define T_CONNECT_ARRAY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\connect_array\\T_connect_array.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_connect_array-struct.h"
...
struct __devstruct_0test_0c {
    conf_object_t *obj[2][3];
    char *port[2][3];
    signal_interface_t const *signal[2][3];
};
struct test {
    conf_object_t obj;
