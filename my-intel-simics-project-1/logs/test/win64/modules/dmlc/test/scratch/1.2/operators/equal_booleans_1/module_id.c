...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860265" ";"
	"MOD:" "dml-test-equal_booleans_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:25 2025";
extern void _initialize_T_equal_booleans_1(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_equal_booleans_1();
	init_local();
}
