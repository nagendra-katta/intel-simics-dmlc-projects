...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860248" ";"
	"MOD:" "dml-test-inheritance_from_14" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:08 2025";
extern void _initialize_T_inheritance_from_14(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_inheritance_from_14();
	init_local();
}
