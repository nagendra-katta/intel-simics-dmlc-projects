 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_incdec.dml
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                    {
                        char v11_a[10] UNUSED ;
                        #line 10 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        memset((void *)&v11_a, 0, sizeof(char [10]));
                        char *v11_p1 UNUSED  = NULL;
                        char *v11_p2 UNUSED  = NULL;
                        int v11_i UNUSED  = 0;
                        uint24_le_t v11_le UNUSED ;
                        #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        memset((void *)&v11_le, 0, sizeof(uint24_le_t ));
                        uint24_be_t v11_be UNUSED ;
                        #line 15 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        memset((void *)&v11_be, 0, sizeof(uint24_be_t ));
                        #line 17 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        v10_ok = 1;
                        #line 19 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        v11_i = 17;
                        v10_ok = v10_ok && (v11_i)++ == 17;
                        v10_ok = v10_ok && (v11_i)-- == 18;
                        v10_ok = v10_ok && ++(v11_i) == 18;
                        v10_ok = v10_ok && --(v11_i) == 17;
                        #line 25 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        dml_copy_uint24_le_t(&v11_le, dml_store_uint24_le_t(0xffffffULL));
                        v10_ok = v10_ok && dml_prechange_uint24_le_t(&v11_le, 1, true) == 0xffffff;
                        v10_ok = v10_ok && dml_prechange_uint24_le_t(&v11_le, -1, true) == 0;
                        v10_ok = v10_ok && dml_prechange_uint24_le_t(&v11_le, 1, false) == 0;
                        v10_ok = v10_ok && dml_prechange_uint24_le_t(&v11_le, -1, false) == 0xffffff;
                        #line 31 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        dml_copy_uint24_be_t(&v11_be, dml_store_uint24_be_t(0xffffffULL));
                        v10_ok = v10_ok && dml_prechange_uint24_be_t(&v11_be, 1, true) == 0xffffff;
                        v10_ok = v10_ok && dml_prechange_uint24_be_t(&v11_be, -1, true) == 0;
                        v10_ok = v10_ok && dml_prechange_uint24_be_t(&v11_be, 1, false) == 0;
                        v10_ok = v10_ok && dml_prechange_uint24_be_t(&v11_be, -1, false) == 0xffffff;
                        #line 43 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_incdec.dml"
                        v11_p1 = &v11_a[5];
                        v11_p2 = v11_p1;
                        v10_ok = v10_ok && v11_p1 < ++(v11_p2);
                        v11_p2 = v11_p1;
                        v10_ok = v10_ok && v11_p1 > --(v11_p2);
                        v11_p2 = v11_p1;
                        v10_ok = v10_ok && v11_p1 == (v11_p2)++;
    ...
    #line 166 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\incdec\\T_incdec.c"
    _val0 = v3_value;
    return _val0;
}
