 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_equal_booleans_1.dml
...
#include "T_equal_booleans_1.h"
#include "T_equal_booleans_1-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_equal_booleans_1.dml"
                    {
                        uint8 v11_x UNUSED  = 255;
                        bool v11_xb UNUSED  = 0;
                        bool v11_yb UNUSED  = 0;
                        v11_xb = (uint8 )((uint8 )(v11_x >> 1 & 1));
                        v11_yb = (uint8 )((uint8 )(v11_x >> 2 & 1));
                        v10_b = v11_xb == v11_yb;
                    }
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_equal_booleans_1.dml"
                    v9_result = v10_b;
    ...
    #line 130 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\equal_booleans_1\\T_equal_booleans_1.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_equal_booleans_1(void)
{
