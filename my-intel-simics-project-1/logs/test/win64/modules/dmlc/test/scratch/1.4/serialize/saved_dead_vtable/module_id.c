...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860486" ";"
	"MOD:" "dml-test-saved_dead_vtable" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:06 2025";
extern void _initialize_T_saved_dead_vtable(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_saved_dead_vtable();
	init_local();
}
