...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860271" ";"
	"MOD:" "dml-test-sizeof_layout" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:31 2025";
extern void _initialize_T_sizeof_layout(void);
