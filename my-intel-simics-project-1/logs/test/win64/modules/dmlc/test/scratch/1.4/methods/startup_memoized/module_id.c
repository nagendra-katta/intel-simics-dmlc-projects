...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860460" ";"
	"MOD:" "dml-test-startup_memoized" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:40 2025";
extern void _initialize_T_startup_memoized(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_startup_memoized();
	init_local();
}
