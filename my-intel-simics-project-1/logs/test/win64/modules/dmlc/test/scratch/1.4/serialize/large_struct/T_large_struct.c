 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\serialize\T_large_struct.dml
...
#include "T_large_struct.h"
#include "T_large_struct-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 112 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\large_struct\\T_large_struct.c"
...
#line 51 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\serialize\\\\T_large_struct.dml"
{
    run_test(&_dev->obj, (int32 )0x186a0LL);
    return;
    #line 53 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\serialize\\\\T_large_struct.dml"
}
#line 3489 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\large_struct\\T_large_struct.c"
...
conf_class_t *
_initialize_T_large_struct(void)
{
    ...
    _register_events(class);
    {
        ...
        static const _saved_userdata_t saved_userdata[1] = {
            {offsetof(test_t, x), 0, NULL, NULL, DML_deserialize_Shuge_t, DML_serialize_Shuge_t},
        };
...
attr_value_t DML_serialize_Shuge_t(void const  *_in) {
    struct huge_t *in = (struct huge_t *)_in;
    attr_value_t out;
    {
        {
        ...
        {
            _imm_attr = _serialize_array(&in->data, sizeof(uint8 ), (const uint32 []) { 0x30d40LL }, 1LL, NULL);
        }
...
set_error_t DML_deserialize_Shuge_t(attr_value_t in, void  *_out) {
    struct huge_t *out = (struct huge_t *)_out;
    set_error_t _success UNUSED = Sim_Set_Ok;
    struct huge_t *_tmp_out = MM_ZALLOC(1, struct huge_t );
    if (SIM_attr_is_list(in) && (int64 )SIM_attr_list_size(in) == 1ULL)
    {
        ...
        }
        {
            ...
            {
                _sub_success = _deserialize_array(_imm_attr, &_tmp_out->data, sizeof(uint8 ), (const uint32 []) { 0x30d40LL }, 1LL, DML_deserialize_I8hu, 1);
            }
    ...
    {
        _success = Sim_Set_Illegal_Type;
        SIM_attribute_error("expected list of size 1 during deserialization of struct huge_t");
        goto _exit;
    }
    {
        *out = *_tmp_out;
