...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860492" ";"
	"MOD:" "dml-test-hashforeach" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:12 2025";
extern void _initialize_T_hashforeach(void);
