...
#ifndef T_PORT_ARRAY_H
#define T_PORT_ARRAY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\port_array\\T_port_array.h"
...
struct __devstruct_0test_0prt {
    conf_object_t *_obj[4];
    bool raised[4];
};
struct __devstruct_0test_0prtarr {
    conf_object_t *_obj[4][3];
    bool raised[4][3];
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0prt prt;
    struct __devstruct_0test_0prtarr prtarr;
};
