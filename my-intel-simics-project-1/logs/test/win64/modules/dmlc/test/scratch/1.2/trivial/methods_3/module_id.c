...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860350" ";"
	"MOD:" "dml-test-methods_3" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:50 2025";
extern void _initialize_T_methods_3(void);
