...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860516" ";"
	"MOD:" "dml-test-designated_initializers" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:36 2025";
extern void _initialize_T_designated_initializers(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_designated_initializers();
	init_local();
}
