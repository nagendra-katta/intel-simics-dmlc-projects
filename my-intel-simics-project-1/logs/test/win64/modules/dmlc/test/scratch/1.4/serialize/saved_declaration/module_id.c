...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860493" ";"
	"MOD:" "dml-test-saved_declaration" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:13 2025";
extern void _initialize_T_saved_declaration(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_saved_declaration();
	init_local();
}
