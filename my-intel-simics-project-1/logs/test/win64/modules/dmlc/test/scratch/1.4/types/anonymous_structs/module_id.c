...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860521" ";"
	"MOD:" "dml-test-anonymous_structs" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:41 2025";
extern void _initialize_T_anonymous_structs(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_anonymous_structs();
	init_local();
}
