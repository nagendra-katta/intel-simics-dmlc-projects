...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860419" ";"
	"MOD:" "dml-test-meaningless_log_levels_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:59 2025";
extern void _initialize_T_meaningless_log_levels_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_meaningless_log_levels_enabled();
	init_local();
}
