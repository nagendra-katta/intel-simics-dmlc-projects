...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\events\\after\\T_after.h"
...
typedef _traitref_t trigger_attr;
typedef _traitref_t init;
typedef _traitref_t int64_attr;
typedef _traitref_t operator;
...
struct _simple_event_4_args {
    chunk_t chunk;
    int ix;
};
struct _simple_event_5_args {
    _hookref_t hookref;
    struct _typeseq_1 args;
};

struct __devstruct_0test_1constig_res {
    uint64 val[2LL];
};
struct __devstruct_0test_1hook_operator {
    int64 val[2LL][2LL];
    _dml_hook_t h[2LL][2LL];
};
struct __devstruct_0test_1multi_operator {
    int64 val[2LL][2LL];
};
struct __devstruct_0test_1single_operator {
    int64 val;
};
struct __devstruct_0test_0trigger {
    int val[2LL][2LL];
};
struct __devstruct_0test_1trigger_hook {
    int val[2LL];
    _dml_hook_t h[2LL];
};
struct test {
    ...
    struct __devstruct_0test_1constig_res constig_res;
    struct __devstruct_0test_1hook_operator hook_operator;
    struct __devstruct_0test_1multi_operator multi_operator;
    struct __devstruct_0test_1single_operator single_operator;
    struct __devstruct_0test_0trigger trigger;
    struct __devstruct_0test_1trigger_hook trigger_hook;
};
