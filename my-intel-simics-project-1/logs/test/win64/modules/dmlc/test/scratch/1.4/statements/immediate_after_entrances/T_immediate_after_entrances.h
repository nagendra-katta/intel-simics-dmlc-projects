...
#ifndef T_IMMEDIATE_AFTER_ENTRANCES_H
#define T_IMMEDIATE_AFTER_ENTRANCES_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\statements\\immediate_after_entrances\\T_immediate_after_entrances.h"
...
#define DMLDIR_T_IMMEDIATE_AFTER_ENTRANCES_H "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\statements\\T_immediate_after_entrances.h"
...
#line 438 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\statements\\immediate_after_entrances\\T_immediate_after_entrances.h"
#undef DMLDIR_T_IMMEDIATE_AFTER_ENTRANCES_H


#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_immediate_after_entrances-struct.h"
...
struct _immediate_after_1_args {
    char const *name;
};
...
struct __devstruct_0test_3error_on_post_init {
    bool val;
};
struct __devstruct_0test_0notifiers {
    notifier_handle_t *handle[2LL];
};
struct __devstruct_0test_0out_0signal {
    void const  *val;
};
struct __devstruct_0test_0out {
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0out_0signal signal;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_3error_on_post_init error_on_post_init;
    struct __devstruct_0test_0notifiers notifiers;
    struct __devstruct_0test_0out out;
};
...
#endif /* not T_IMMEDIATE_AFTER_ENTRANCES_H */
