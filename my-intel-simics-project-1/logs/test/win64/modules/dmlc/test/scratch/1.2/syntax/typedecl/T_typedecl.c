...
#include "T_typedecl.h"
#include "T_typedecl-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 129 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\syntax\\typedecl\\T_typedecl.c"
    _val0 = v3_value;
    return _val0;
}
