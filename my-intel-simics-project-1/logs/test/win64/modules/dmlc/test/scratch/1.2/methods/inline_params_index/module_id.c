...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860236" ";"
	"MOD:" "dml-test-inline_params_index" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:56 2025";
extern void _initialize_T_inline_params_index(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_inline_params_index();
	init_local();
}
