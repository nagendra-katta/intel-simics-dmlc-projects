...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860447" ";"
	"MOD:" "dml-test-io_memory" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:27 2025";
extern void _initialize_T_io_memory(void);
