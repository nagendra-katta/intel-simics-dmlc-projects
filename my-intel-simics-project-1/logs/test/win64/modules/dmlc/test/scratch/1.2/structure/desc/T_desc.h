...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\desc\\T_desc.h"
...
struct __devstruct_0test_0descb {
    conf_object_t *_obj;
...
struct __devstruct_0test_0descp {
    conf_object_t *_obj;
};
struct __devstruct_0test_0nodescb {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct __devstruct_0test_0nodescp {
    conf_object_t *_obj;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0descb descb;
    struct __devstruct_0test_0descp descp;
    struct __devstruct_0test_0nodescb nodescb;
    struct __devstruct_0test_0nodescp nodescp;
};
