...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860311" ";"
	"MOD:" "dml-test-attribute_throw" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:11 2025";
extern void _initialize_T_attribute_throw(void);
