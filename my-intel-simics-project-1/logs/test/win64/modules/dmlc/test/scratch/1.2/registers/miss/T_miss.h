...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\registers\\miss\\T_miss.h"
...
struct __devstruct_0test_0noover {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct __devstruct_0test_0nopart {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct test {
    ...
    bool missed;
    struct __devstruct_0test_0noover noover;
    struct __devstruct_0test_0nopart nopart;
};
