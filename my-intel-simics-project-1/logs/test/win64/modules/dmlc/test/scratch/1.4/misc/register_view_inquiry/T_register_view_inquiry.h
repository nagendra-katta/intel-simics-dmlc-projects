...
#ifndef T_REGISTER_VIEW_INQUIRY_H
#define T_REGISTER_VIEW_INQUIRY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\misc\\register_view_inquiry\\T_register_view_inquiry.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_register_view_inquiry-struct.h"
...
struct __devstruct_0test_0inquiry_0r {
    uint64 val;
};
struct __devstruct_0test_0inquiry {
    ...
    struct __devstruct_0test_0inquiry_0r r;
};
struct __devstruct_0test_1read_raised {
    bool val;
};
struct __devstruct_0test_1write_raised {
    bool val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1read_raised read_raised;
    struct __devstruct_0test_1write_raised write_raised;
};
...
#endif /* not T_REGISTER_VIEW_INQUIRY_H */
