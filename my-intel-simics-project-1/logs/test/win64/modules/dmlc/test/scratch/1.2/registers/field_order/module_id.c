...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860281" ";"
	"MOD:" "dml-test-field_order" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:41 2025";
extern void _initialize_T_field_order(void);
