...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860491" ";"
	"MOD:" "dml-test-instrumentation_transaction" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:11 2025";
extern void _initialize_T_instrumentation_transaction(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_instrumentation_transaction();
	init_local();
}
