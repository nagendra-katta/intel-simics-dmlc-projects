...
#ifndef T_ARRAY_SET_7_H
#define T_ARRAY_SET_7_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\array_set_7\\T_array_set_7.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_array_set_7-struct.h"
...
struct __devstruct_0test_0b_0q {
    uint32 __DMLfield[4][4];
    uint8 f1[4][4];
};
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_0q q;
    uint32 r[4][4];
};
struct test {
    conf_object_t obj;
