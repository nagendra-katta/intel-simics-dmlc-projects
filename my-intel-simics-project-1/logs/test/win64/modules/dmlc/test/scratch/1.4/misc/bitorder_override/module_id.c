...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860465" ";"
	"MOD:" "dml-test-bitorder_override" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:45 2025";
extern void _initialize_T_bitorder_override(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_bitorder_override();
	init_local();
}
