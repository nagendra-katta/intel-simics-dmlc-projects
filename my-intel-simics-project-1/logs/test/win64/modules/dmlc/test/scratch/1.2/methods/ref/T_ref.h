...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\methods\\ref\\T_ref.h"
...
struct __devstruct_0test_0b {
    conf_object_t *_obj[9];
    _callback_vect_t _after_read_callbacks[9];
    _callback_vect_t _after_write_callbacks[9];
    _callback_vect_t _before_read_callbacks[9];
    _callback_vect_t _before_write_callbacks[9];
    conf_object_t *_cached_bank_obj[9];
    _connection_vect_t _connections[9];
};
struct test {
    conf_object_t obj;
