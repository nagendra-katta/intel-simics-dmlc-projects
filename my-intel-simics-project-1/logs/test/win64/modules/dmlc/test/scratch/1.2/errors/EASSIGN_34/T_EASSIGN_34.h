...
#ifndef T_EASSIGN_34_H
#define T_EASSIGN_34_H

#define DML_PREFIX(x) eassign_##x
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\errors\\EASSIGN_34\\T_EASSIGN_34.h"
...
// which saves space
STATIC_ASSERT(sizeof(struct eassign) <= UINT32_MAX);
static const uint64 Register_Read UNUSED = 1ULL;
static const uint64 Register_Write UNUSED = 2ULL;

void hard_reset_eassign(eassign_t *_obj);
void soft_reset_eassign(eassign_t *_obj);

#endif /* not T_EASSIGN_34_H */
