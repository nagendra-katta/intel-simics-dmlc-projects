...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860411" ";"
	"MOD:" "dml-test-nested-assignment" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:51 2025";
extern void _initialize_T_nested_assignment(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_nested_assignment();
	init_local();
}
