...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860408" ";"
	"MOD:" "dml-test-mixed_endian" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:48 2025";
extern void _initialize_T_mixed_endian(void);
