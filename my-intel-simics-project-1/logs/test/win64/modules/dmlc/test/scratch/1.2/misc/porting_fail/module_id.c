...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860253" ";"
	"MOD:" "dml-test-porting_fail" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:13 2025";
extern void _initialize_T_porting_fail(void);
