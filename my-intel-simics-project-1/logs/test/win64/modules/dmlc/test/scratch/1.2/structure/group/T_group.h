...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\group\\T_group.h"
...
typedef _traitref_t event_boilerplate;
...
typedef struct i_interface_t i_interface_t;
struct i_interface_t {
    void  (*m)(conf_object_t *arg0, int arg1);
};
...
struct _event_boilerplate {
    struct _custom_time_event custom_time_event;
};
struct _init_val {
};
struct _read_field {
...
struct __devstruct_0test_0b_0gh {
    uint32 r;
};
...
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_0gh gh;
    struct __devstruct_0test_0b_0r r;
};
struct __devstruct_0test_0c {
    conf_object_t *obj;
    char *port;
    i_interface_t const *i;
};
struct __devstruct_0test_0g_0c {
    conf_object_t *obj;
    char *port;
    i_interface_t const *i;
};
struct __devstruct_0test_0g {
    uint64 a;
    struct __devstruct_0test_0g_0c c;
};
struct __devstruct_0test_0ga_0p {
    conf_object_t *_obj[2LL][3LL][5LL][7LL];
};
struct __devstruct_0test_0ga {
    struct __devstruct_0test_0ga_0p p;
};
struct __devstruct_0test_0p_0i_0g {
    int x;
    int s;
    uint64 a;
};
struct __devstruct_0test_0p_0i {
    uint64 a;
    struct __devstruct_0test_0p_0i_0g g;
};
struct __devstruct_0test_0p {
    conf_object_t *_obj;
    struct __devstruct_0test_0p_0i i;
};
struct __devstruct_0test_0pa_0p {
    conf_object_t *_obj[2LL][3LL][5LL][7LL];
};
struct __devstruct_0test_0pa {
    conf_object_t *_obj[2LL][3LL];
    struct __devstruct_0test_0pa_0p p;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0ga ga;
    struct __devstruct_0test_0p p;
    struct __devstruct_0test_0pa pa;
};
