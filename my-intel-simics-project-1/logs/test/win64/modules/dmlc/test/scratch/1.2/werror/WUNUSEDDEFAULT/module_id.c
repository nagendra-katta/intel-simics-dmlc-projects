...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860361" ";"
	"MOD:" "dml-test-WUNUSEDDEFAULT" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:01 2025";
extern void _initialize_T_WUNUSEDDEFAULT(void);
