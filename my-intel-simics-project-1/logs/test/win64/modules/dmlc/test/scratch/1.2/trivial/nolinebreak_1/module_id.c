...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860354" ";"
	"MOD:" "dml-test-nolinebreak_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:54 2025";
extern void _initialize_T_nolinebreak_1(void);
