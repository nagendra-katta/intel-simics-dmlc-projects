...
#ifndef T_STARTUP_MEMOIZED_H
#define T_STARTUP_MEMOIZED_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\methods\\startup_memoized\\T_startup_memoized.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_startup_memoized-struct.h"
...
struct _memo_t__s_memo_0_t {
    int8 ran;
    bool threw;
};
struct _memo_t__s_memo_0_nt {
    int8 ran;
    bool threw;
};
struct _memo_t__s_memo_1 {
    int p__out0;
    int8 ran;
};
struct _memo_t__s_memo_2 {
    int p__out0;
    double p__out1;
    int8 ran;
};
struct _memo_t__s_memo_2_t {
    int p__out0;
    double p__out1;
    int8 ran;
    bool threw;
};
struct _memo_t__s_memo_2_nt {
    int p__out0;
    double p__out1;
    int8 ran;
    bool threw;
...
struct _t {
    struct _name name;
    struct _memo_t__s_memo_0_t *_memo_outs_s_memo_0_t;
    struct _memo_t__s_memo_0_nt *_memo_outs_s_memo_0_nt;
    struct _memo_t__s_memo_1 *_memo_outs_s_memo_1;
    struct _memo_t__s_memo_2 *_memo_outs_s_memo_2;
    struct _memo_t__s_memo_2_t *_memo_outs_s_memo_2_t;
    struct _memo_t__s_memo_2_nt *_memo_outs_s_memo_2_nt;
};
struct __qname {
};
struct _desc {
...
#endif /* not T_STARTUP_MEMOIZED_H */
