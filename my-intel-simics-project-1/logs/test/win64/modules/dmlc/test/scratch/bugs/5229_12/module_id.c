...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860532" ";"
	"MOD:" "dml-test-5229_12" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:52 2025";
extern void _initialize_T_5229_12(void);
