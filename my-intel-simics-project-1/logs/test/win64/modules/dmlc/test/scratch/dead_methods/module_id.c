...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860160" ";"
	"MOD:" "dml-test-dead_methods" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:52:40 2025";
extern void _initialize_T_dead_methods(void);
