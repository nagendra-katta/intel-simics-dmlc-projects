...
#ifndef T_CALL_EXPR_H
#define T_CALL_EXPR_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\methods\\call_expr\\T_call_expr.h"
...
struct __devstruct_0test_0b_0g {
    bool called[11][11];
};
struct __devstruct_0test_0b {
    conf_object_t *_obj[11];
    _callback_vect_t _after_read_callbacks[11];
    _callback_vect_t _after_write_callbacks[11];
    _callback_vect_t _before_read_callbacks[11];
    _callback_vect_t _before_write_callbacks[11];
    conf_object_t *_cached_bank_obj[11];
    _connection_vect_t _connections[11];
    struct __devstruct_0test_0b_0g g;
};
struct test {
    conf_object_t obj;
