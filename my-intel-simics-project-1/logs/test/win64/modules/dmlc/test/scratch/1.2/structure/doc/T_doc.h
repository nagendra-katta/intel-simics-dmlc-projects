...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\doc\\T_doc.h"
...
struct __devstruct_0test_1doc_desc {
    conf_object_t *_obj;
...
struct __devstruct_0test_1doc_only {
    conf_object_t *_obj;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1doc_desc doc_desc;
    struct __devstruct_0test_1doc_only doc_only;
};
