...
#ifndef T_ENAMECOLL_UINT32_H
#define T_ENAMECOLL_UINT32_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\errors\\ENAMECOLL_uint32\\T_ENAMECOLL_uint32.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_ENAMECOLL_uint32-struct.h"
...
static const uint64 uint32 UNUSED = 1ULL;
static const uint64 Register_Read UNUSED = 2ULL;
static const uint64 Register_Write UNUSED = 4ULL;

void hard_reset_test(test_t *_obj);
void soft_reset_test(test_t *_obj);

#endif /* not T_ENAMECOLL_UINT32_H */
