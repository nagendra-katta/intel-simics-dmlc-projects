...
#define DMLDIR_T_NOTIFY_STATE_H "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\misc\\T_notify_state.h"
...
struct __devstruct_0test_0count {
    uint64 count;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0count count;
};
