...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\field\\T_field.h"
...
typedef _traitref_t use_val;
typedef _traitref_t use_get_val;
...
typedef _traitref_t field_order;
...
typedef _traitref_t __implicit_register__use_val;
typedef _traitref_t __implicit__get_field___set_field__field__use_val;
typedef _traitref_t __implicit_register__use_get_val;
typedef _traitref_t __implicit__get_field___set_field__field__use_get_val;
...
struct ___implicit_register__use_val {
    struct __register _register;
    struct _use_val use_val;
};
struct ___implicit__get_field___set_field__field__use_val {
    struct __get_field _get_field;
    struct __set_field _set_field;
    struct _field field;
    struct _use_val use_val;
};
struct ___implicit_register__use_get_val {
    struct __register _register;
    struct _use_get_val use_get_val;
};
struct ___implicit__get_field___set_field__field__use_get_val {
    struct __get_field _get_field;
    struct __set_field _set_field;
    struct _field field;
    struct _use_get_val use_get_val;
