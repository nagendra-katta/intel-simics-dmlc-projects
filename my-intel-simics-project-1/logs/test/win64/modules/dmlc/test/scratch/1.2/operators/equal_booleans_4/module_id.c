...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860266" ";"
	"MOD:" "dml-test-equal_booleans_4" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:26 2025";
extern void _initialize_T_equal_booleans_4(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_equal_booleans_4();
	init_local();
}
