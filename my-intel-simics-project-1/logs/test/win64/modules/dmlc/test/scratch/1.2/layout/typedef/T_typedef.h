...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\typedef\\T_typedef.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_typedef-struct.h"

typedef _traitref_t object;
typedef struct ty_be_layout ty_be_layout;
typedef struct ty_le_layout ty_le_layout;
typedef struct to_test_layout to_test_layout;
typedef int32 ty_int24;

typedef int48_be_t ty_int48_be_t;

typedef int56_le_t ty_int56_le_t;

typedef uint32 ty_bitfield;
...
typedef int32 ty_int24_array[2];

typedef ty_le_layout ty_le_layout_array[2];

struct to_test_layout {
    int24_be_t int24_member;
    int48_be_t int48_be_member;
    int56_le_t int56_le_member;
    uint24_be_t bitfield_member;
    ty_be_layout be_layout_member;
    ty_le_layout le_layout_member;
    int24_be_t int24_array_member[2];
    ty_le_layout le_layout_array_member[2];
};
