 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\hooks\T_bad_hookattr_set.dml
...
#include "T_bad_hookattr_set.h"
#include "T_bad_hookattr_set-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 111 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\bad_hookattr_set\\T_bad_hookattr_set.c"
...
#line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
{
    { _DML_attach_callback_to_hook(&_dev->h, &_after_on_hook_infos[0], (const uint32 []) {2LL}, 1, (struct _after_on_hook_0_args [1LL]){{ (int32 )2LL, 1 }}, (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    { _DML_attach_callback_to_hook(&_dev->h, &_after_on_hook_infos[1], NULL, 0, (struct _after_on_hook_1_args [1LL]){{ (int32 )4LL }}, (const _identity_t []) {((_identity_t) {.id = 1, .encoded_index = 0})}, 1); }
    return;
    #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
}
#line 3485 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\bad_hookattr_set\\T_bad_hookattr_set.c"
...
/* n */
static void  _DML_M_n(test_t *_dev, int i)
#line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
{
    return;
    #line 22 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
...
/* g[i].m */
static void  _DML_M_g__m(test_t *_dev, uint32 _idx0, int i, bool b)
#line 17 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
{
    return;
    #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.4\\\\hooks\\\\T_bad_hookattr_set.dml"
...
conf_class_t *
_initialize_T_bad_hookattr_set(void)
{
...
static void _after_on_hook_0_callback(conf_object_t *_obj, const uint32 *indices, const void *_args, const void *_msg)
{
    ...
    _DML_M_g__m(_dev, indices[0], args->i, args->b);
}
...
static attr_value_t _after_on_hook_0_args_serializer(const void *_args)
{
    ...
    attr_value_t out;
    {
        ...
        {
            _imm_attr = SIM_make_attr_int64((args)->i);
        }
        SIM_attr_list_set_item(&out, 0ULL, _imm_attr);
        {
            _imm_attr = SIM_make_attr_boolean((args)->b);
        }
...
static set_error_t _after_on_hook_0_args_deserializer(attr_value_t val, void *_out)
{
    ...
    if (SIM_attr_is_list(val) && (int64 )SIM_attr_list_size(val) == 2ULL)
    {
        ...
        else
        {
            ...
            SIM_attribute_error("expected integer during deserialization of list item 0 during deserialization of arguments to m");
            goto _exit;
        }
        {
            _imm_attr = SIM_attr_list_item(val, 1ULL);
        }
        if (SIM_attr_is_boolean(_imm_attr))
        {
            _tmp_out.b = SIM_attr_boolean(_imm_attr);
        }
        else
        {
            _success = Sim_Set_Illegal_Type;
            SIM_attribute_error("expected boolean during deserialization of list item 1 during deserialization of arguments to m");
            goto _exit;
        }
    }
    else
    {
        _success = Sim_Set_Illegal_Type;
        SIM_attribute_error("expected list of size 2 during deserialization of arguments to m");
        goto _exit;
    }
    {
        *(out) = _tmp_out;
...
static set_error_t _after_on_hook_1_args_deserializer(attr_value_t val, void *_out)
{
    ...
    if (SIM_attr_is_list(val) && (int64 )SIM_attr_list_size(val) == 1ULL)
    {
        ...
        {
            _success = Sim_Set_Illegal_Type;
            SIM_attribute_error("expected integer during deserialization of list item 0 during deserialization of arguments to n");
            goto _exit;
        }
    }
    else
    {
        _success = Sim_Set_Illegal_Type;
        SIM_attribute_error("expected list of size 1 during deserialization of arguments to n");
        goto _exit;
    }
    {
        *(out) = _tmp_out;
...
static const _dml_after_on_hook_info_t _after_on_hook_infos[] UNUSED = {
    {"('g[%u].m', (None, None))", _after_on_hook_0_callback, _after_on_hook_0_args_serializer, _after_on_hook_0_args_deserializer, sizeof(struct _after_on_hook_0_args ), 2},
    {"('n', (None,))", _after_on_hook_1_callback, _after_on_hook_1_args_serializer, _after_on_hook_1_args_deserializer, sizeof(struct _after_on_hook_1_args ), 1}
};
