...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860260" ";"
	"MOD:" "dml-test-arrayref_node_nonint" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:20 2025";
extern void _initialize_T_arrayref_node_nonint(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_arrayref_node_nonint();
	init_local();
}
