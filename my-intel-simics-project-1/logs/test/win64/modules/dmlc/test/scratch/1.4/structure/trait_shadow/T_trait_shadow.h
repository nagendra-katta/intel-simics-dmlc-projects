...
#ifndef T_TRAIT_SHADOW_H
#define T_TRAIT_SHADOW_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\trait_shadow\\T_trait_shadow.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_trait_shadow-struct.h"

typedef _traitref_t shadowed_by_method;
...
struct _shadowed_by_method {
    uint64 (*shadowed_by_method)(test_t *arg0, shadowed_by_method arg1);
    uint64 (*z_other_trait_method)(test_t *arg0, shadowed_by_method arg1);
};
struct _name {
    char const **name;
};
