...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860273" ";"
	"MOD:" "dml-test-slice_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:33 2025";
extern void _initialize_T_slice_1(void);
