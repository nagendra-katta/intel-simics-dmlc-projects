...
#ifndef T_INIT_DATA_H
#define T_INIT_DATA_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\init_data\\T_init_data.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_init_data-struct.h"

typedef _traitref_t object;
typedef struct simple_struct_t simple_struct_t;
typedef struct const_struct_t const_struct_t;
typedef struct a_struct_t a_struct_t;
typedef struct b_struct_t b_struct_t;
...
struct test {
    ...
    a_struct_t a_struct_array[2];
    b_struct_t b_struct;
    uint32 bf_data;
    int const const_array[4];
    int const const_int;
    const_struct_t const_struct;
    int d2_array[2][4];
    int simple_array[4];
    int simple_int;
    simple_struct_t simple_struct;
    char const *str_array[2];
