...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860283" ";"
	"MOD:" "dml-test-large_stride" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:43 2025";
extern void _initialize_T_large_stride(void);
