...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\connect\\T_connect.h"
...
struct __devstruct_0test_0D {
    conf_object_t *obj;
    char *port;
    simple_interrupt_interface_t const *simple_interrupt;
};
struct test {
    conf_object_t obj;
