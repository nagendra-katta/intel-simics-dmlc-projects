...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860321" ";"
	"MOD:" "dml-test-group_attr" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:21 2025";
extern void _initialize_T_group_attr(void);
