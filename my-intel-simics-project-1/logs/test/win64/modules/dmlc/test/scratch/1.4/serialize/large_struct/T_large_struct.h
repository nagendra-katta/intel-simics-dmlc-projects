...
#ifndef T_LARGE_STRUCT_H
#define T_LARGE_STRUCT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\large_struct\\T_large_struct.h"
...
#define DMLDIR_T_LARGE_STRUCT_H "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\serialize\\T_large_struct.h"
#line 22 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\serialize\\T_large_struct.dml"
    ...
    static void run_test(conf_object_t *obj, int stack_limit) {
        ...
        ASSERT(ret == 0);
        if (limit.rlim_cur == -1) {
            // lower limit to make a stack overflow possible
            limit.rlim_cur = 16 * 1024 * 1024;
            ret = setrlimit(RLIMIT_STACK, &limit);
            ASSERT(ret == 0);
        }
        ASSERT(limit.rlim_cur > stack_limit);
/// CC-FLAG -O0
...
#line 458 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\large_struct\\T_large_struct.h"
#undef DMLDIR_T_LARGE_STRUCT_H


#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_large_struct-struct.h"
...
typedef struct huge_t huge_t;
struct huge_t {
    uint8 data[0x30d40LL];
};
