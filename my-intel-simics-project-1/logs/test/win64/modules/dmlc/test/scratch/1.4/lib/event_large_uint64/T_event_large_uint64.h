...
#ifndef T_EVENT_LARGE_UINT64_H
#define T_EVENT_LARGE_UINT64_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\event_large_uint64\\T_event_large_uint64.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_event_large_uint64-struct.h"
...
struct __devstruct_0test_0happened {
    uint64 val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0happened happened;
};
...
#endif /* not T_EVENT_LARGE_UINT64_H */
