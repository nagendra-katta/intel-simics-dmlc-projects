...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860547" ";"
	"MOD:" "dml-test-api-dml-1.4-api-7" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:59:07 2025";
extern void _initialize_T_api_dml_1_4_api_7(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_api_dml_1_4_api_7();
	init_local();
}
