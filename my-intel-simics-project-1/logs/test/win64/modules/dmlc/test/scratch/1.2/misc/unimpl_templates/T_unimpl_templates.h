...
#ifndef T_UNIMPL_TEMPLATES_H
#define T_UNIMPL_TEMPLATES_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\unimpl_templates\\T_unimpl_templates.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_unimpl_templates-struct.h"
...
struct __devstruct_0test_1with_fields_0r6 {
    uint32 __DMLfield;
    uint8 f;
};
struct __devstruct_0test_1with_fields_0r7 {
    uint32 __DMLfield;
    uint8 f;
};
struct __devstruct_0test_1with_fields {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_1with_fields_0r6 r6;
    struct __devstruct_0test_1with_fields_0r7 r7;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1with_fields with_fields;
};
...
#endif /* not T_UNIMPL_TEMPLATES_H */
