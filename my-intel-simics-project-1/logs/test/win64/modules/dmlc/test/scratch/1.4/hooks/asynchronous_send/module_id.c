...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860402" ";"
	"MOD:" "dml-test-asynchronous_send" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:42 2025";
extern void _initialize_T_asynchronous_send(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_asynchronous_send();
	init_local();
}
