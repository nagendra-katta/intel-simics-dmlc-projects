...
set_error_t set_regs_r(conf_object_t *_obj, attr_value_t *_val, lang_void *_aux)
{
    ...
    for (_i1 = 0; _i1 < 2; _i1++) {
        ...
        #line 113 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\split\\T_split-2.c"
        _status = v24_err;
