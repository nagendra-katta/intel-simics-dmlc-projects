...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860336" ";"
	"MOD:" "dml-test-import_alias" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:36 2025";
extern void _initialize_T_import_alias(void);
