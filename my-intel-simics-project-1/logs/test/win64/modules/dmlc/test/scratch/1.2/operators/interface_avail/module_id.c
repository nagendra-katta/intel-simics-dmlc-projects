...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860269" ";"
	"MOD:" "dml-test-interface_avail" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:29 2025";
extern void _initialize_T_interface_avail(void);
