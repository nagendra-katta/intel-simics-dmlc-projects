...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860468" ";"
	"MOD:" "dml-test-notify_state" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:48 2025";
extern void _initialize_T_notify_state(void);
