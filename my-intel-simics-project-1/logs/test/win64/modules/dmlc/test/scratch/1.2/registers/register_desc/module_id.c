...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860297" ";"
	"MOD:" "dml-test-register_desc" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:57 2025";
extern void _initialize_T_register_desc(void);
