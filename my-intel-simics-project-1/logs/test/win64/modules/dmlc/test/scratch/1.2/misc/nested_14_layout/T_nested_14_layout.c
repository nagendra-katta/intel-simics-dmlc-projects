 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\misc\T_nested_14_layout.dml
...
#include "T_nested_14_layout.h"
#include "T_nested_14_layout-protos.c"
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        v10_ok = 1;
                        uint8 *v11_acc UNUSED  = NULL;
                        #line 22 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_nested_14_layout.dml"
                        be_nested_layout v11_nb UNUSED ;
                        #line 22 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_nested_14_layout.dml"
                        memset((void *)&v11_nb, 0, sizeof(be_nested_layout ));
                        dml_copy_uint24_be_t(&v11_nb.a, dml_store_uint24_be_t(0xf00f00ULL));
                        dml_copy_uint8_be_t(&v11_nb.b, dml_store_uint8_be_t(240ULL));
                        dml_copy_int24_le_t(&v11_nb.l.i24, dml_store_int24_le_t(0xf00f00ULL));
                        dml_copy_int56_le_t(&v11_nb.l.a56[0], dml_store_int56_le_t(0xff0f0000000000ULL));
                        dml_copy_int56_le_t(&v11_nb.l.a56[1], dml_store_int56_le_t(0xfff0ff00000000ULL));
                        v11_acc = (uint8 *)&v11_nb;
                        #line 39 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_nested_14_layout.dml"
                        v10_ok = ((((((((((((((((((((v11_acc[0] == 240 && v11_acc[1] == 15) && v11_acc[2] == 0) && v11_acc[3] == 0) && v11_acc[4] == 15) && v11_acc[5] == 240) && v11_acc[6] == 0) && v11_acc[7] == 0) && v11_acc[8] == 0) && v11_acc[9] == 0) && v11_acc[10] == 0) && v11_acc[11] == 15) && v11_acc[12] == 255) && v11_acc[13] == 0) && v11_acc[14] == 0) && v11_acc[15] == 0) && v11_acc[16] == 0) && v11_acc[17] == 255) && v11_acc[18] == 240) && v11_acc[19] == 255) && v11_acc[20] == 240) && v10_ok;
                    }
                    #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_nested_14_layout.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
...
conf_class_t *
_initialize_T_nested_14_layout(void)
{
