...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\const\\T_const.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_const-struct.h"

typedef _traitref_t object;
typedef struct lo_t lo_t;
typedef struct swab_be_t swab_be_t;
typedef struct swab_le_t swab_le_t;
struct lo_t {
    uint8_be_t pad[48];
};
