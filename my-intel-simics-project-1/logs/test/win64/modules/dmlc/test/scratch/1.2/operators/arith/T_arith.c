...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        int v11_x UNUSED  = 17;
                        double v11_d UNUSED  = 0x1.8ae147ae147aep+3;
                        float v11_f UNUSED  = 0x1.1200000000000p+5;
                        int v11_ia[8] UNUSED ;
                        #line 25 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        memset((void *)&v11_ia, 0, sizeof(int [8]));
                        int *v11_ip UNUSED  = NULL;
                        v10_ok = 1;
                        #line 36 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        v10_ok = (((((v10_ok && v11_x * 8 - 1 == 135) && 8 * v11_x - 1 == 135) && v11_x + 8 - 1 == 24) && v11_x - 8 - 1 == 8) && 8 + v11_x - 1 == 24) && 8 - v11_x - 1 == -10;
                        #line 42 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        v10_ok = ((v10_ok && 255 / 0x1.dcd6500000000p+26 > 0) && v11_d * v11_f > 0) && 0x1.8000000000000p+0 - 1 == 0x1.0000000000000p-1;
                        #line 45 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        v11_ip = &v11_ia[1];
                        #line 51 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        v10_ok = ((((v10_ok && v11_ip - v11_ip == 0) && v11_ia - v11_ia == 0) && v11_ip - v11_ia == 1) && v11_ia + 1 == v11_ip) && v11_ip - 1 == v11_ia;
                        #line 59 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                        v10_ok = ((((v10_ok && fn() == 1) && fn() * 0 == 0) && (uint8 )(fn() & 0) == 0) && ((fn() != 0 && 0) || 1)) && fn() == 5;
                        #line 64 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                    }
                    #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_arith.dml"
                    v9_result = v10_ok;
    ...
    #line 143 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\arith\\T_arith.c"
    _val0 = v3_value;
    return _val0;
}
