...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860234" ";"
	"MOD:" "dml-test-inline_iface" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:54 2025";
extern void _initialize_T_inline_iface(void);
