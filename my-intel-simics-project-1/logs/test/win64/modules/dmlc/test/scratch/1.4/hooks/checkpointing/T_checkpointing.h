...
#ifndef T_CHECKPOINTING_H
#define T_CHECKPOINTING_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\checkpointing\\T_checkpointing.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_checkpointing-struct.h"
...
typedef _traitref_t hookset;
typedef _traitref_t hookset_set;
...
typedef struct _typeseq_3 _typeseq_3_t;

struct _after_on_hook_4_args {
    bf_t i;
};
struct _after_on_hook_6_args {
    bf_t coeff;
};
struct _after_on_hook_7_args {
    bf_t i;
};
struct _after_on_hook_9_args {
    bf_t coeff;
};
struct _after_on_hook_10_args {
    bf_t i;
};
struct _after_on_hook_12_args {
    bf_t coeff;
};
struct _after_on_hook_16_inner_args {
    uint16 comp1;
};
struct _after_on_hook_16_args {
    _hookref_t hookref;
    struct _after_on_hook_16_inner_args args;
};
struct _after_on_hook_17_inner_args {
    uint16 comp0;
};
struct _after_on_hook_17_args {
    _hookref_t hookref;
    struct _after_on_hook_17_inner_args args;
};
struct _after_on_hook_19_inner_args {
    uint16 comp1;
};
struct _after_on_hook_19_args {
    _hookref_t hookref;
    struct _after_on_hook_19_inner_args args;
};
struct _after_on_hook_21_inner_args {
    uint16 comp0;
};
struct _after_on_hook_21_args {
    _hookref_t hookref;
    struct _after_on_hook_21_inner_args args;
};

struct __devstruct_0test_0b1_0g {
    _dml_hook_t _h0[4LL];
    _dml_hook_t _h1[4LL];
    _dml_hook_t _h2[4LL];
    _dml_hook_t _h3[4LL][6LL][8LL];
    _dml_hook_t _h4[4LL][6LL][8LL];
    _dml_hook_t _h5[4LL][6LL][8LL];
    _dml_hook_t _h6[4LL];
};
struct __devstruct_0test_0b1 {
    ...
    _dml_hook_t _h1;
    _dml_hook_t _h2;
    _dml_hook_t _h3[6LL][8LL];
    _dml_hook_t _h4[6LL][8LL];
    _dml_hook_t _h5[6LL][8LL];
    _dml_hook_t _h6;
    struct __devstruct_0test_0b1_0g g;
};
struct __devstruct_0test_0b2_0g {
    _dml_hook_t _h0[3LL][4LL];
    _dml_hook_t _h1[3LL][4LL];
    _dml_hook_t _h2[3LL][4LL];
    _dml_hook_t _h3[3LL][4LL][6LL][8LL];
    _dml_hook_t _h4[3LL][4LL][6LL][8LL];
    _dml_hook_t _h5[3LL][4LL][6LL][8LL];
    _dml_hook_t _h6[3LL][4LL];
};
struct __devstruct_0test_0b2 {
    ...
    _dml_hook_t _h1[3LL];
    _dml_hook_t _h2[3LL];
    _dml_hook_t _h3[3LL][6LL][8LL];
    _dml_hook_t _h4[3LL][6LL][8LL];
    _dml_hook_t _h5[3LL][6LL][8LL];
    _dml_hook_t _h6[3LL];
    struct __devstruct_0test_0b2_0g g;
};
...
struct __devstruct_0test_1via_hookref_0b1_0g {
    _hookref_t h3_arr[4LL][6LL][8LL];
    _hookref_t h4_arr[4LL][6LL][8LL];
    _hookref_t h5_arr[4LL][6LL][8LL];
    _dml_hook_t _h0[4LL];
    _dml_hook_t _h1[4LL];
    _dml_hook_t _h2[4LL];
    _dml_hook_t _h3[4LL][6LL][8LL];
...
struct __devstruct_0test_1via_hookref_0b1 {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    _hookref_t h3_arr[6LL][8LL];
    _hookref_t h4_arr[6LL][8LL];
    _hookref_t h5_arr[6LL][8LL];
    _dml_hook_t _h0;
    _dml_hook_t _h1;
    _dml_hook_t _h2;
    _dml_hook_t _h3[6LL][8LL];
    ...
    _dml_hook_t _h5[6LL][8LL];
    _dml_hook_t _h6;
    struct __devstruct_0test_1via_hookref_0b1_0g g;
};
struct __devstruct_0test_1via_hookref_0b2_0g {
    _hookref_t h3_arr[3LL][4LL][6LL][8LL];
    _hookref_t h4_arr[3LL][4LL][6LL][8LL];
    _hookref_t h5_arr[3LL][4LL][6LL][8LL];
    _dml_hook_t _h0[3LL][4LL];
    _dml_hook_t _h1[3LL][4LL];
    _dml_hook_t _h2[3LL][4LL];
    _dml_hook_t _h3[3LL][4LL][6LL][8LL];
...
struct __devstruct_0test_1via_hookref_0b2 {
    conf_object_t *_obj[3LL];
    _callback_vect_t _after_read_callbacks[3LL];
    _callback_vect_t _after_write_callbacks[3LL];
    _callback_vect_t _before_read_callbacks[3LL];
    ...
    conf_object_t *_cached_bank_obj[3LL];
    _connection_vect_t _connections[3LL];
    _hookref_t h3_arr[3LL][6LL][8LL];
    _hookref_t h4_arr[3LL][6LL][8LL];
    _hookref_t h5_arr[3LL][6LL][8LL];
    _dml_hook_t _h0[3LL];
    _dml_hook_t _h1[3LL];
    _dml_hook_t _h2[3LL];
    _dml_hook_t _h3[3LL][6LL][8LL];
    ...
    _dml_hook_t _h5[3LL][6LL][8LL];
    _dml_hook_t _h6[3LL];
    struct __devstruct_0test_1via_hookref_0b2_0g g;
};
struct __devstruct_0test_1via_hookref_0g {
    _hookref_t h3_arr[4LL][6LL][8LL];
    _hookref_t h4_arr[4LL][6LL][8LL];
    _hookref_t h5_arr[4LL][6LL][8LL];
    _dml_hook_t _h0[4LL];
...
struct __devstruct_0test_1via_hookref {
    _dml_hook_t _h0;
    _dml_hook_t _h1;
    _dml_hook_t _h2;
    _dml_hook_t _h3[6LL][8LL];
    ...
    _dml_hook_t _h5[6LL][8LL];
    _dml_hook_t _h6;
    struct __devstruct_0test_1via_hookref_0b1 b1;
    struct __devstruct_0test_1via_hookref_0b2 b2;
    struct __devstruct_0test_1via_hookref_0g g;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1via_hookref via_hookref;
};
