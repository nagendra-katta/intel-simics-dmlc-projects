...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860200" ";"
	"MOD:" "dml-test-WUNUSEDDEFAULT_01" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:20 2025";
extern void _initialize_T_WUNUSEDDEFAULT_01(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_WUNUSEDDEFAULT_01();
	init_local();
}
