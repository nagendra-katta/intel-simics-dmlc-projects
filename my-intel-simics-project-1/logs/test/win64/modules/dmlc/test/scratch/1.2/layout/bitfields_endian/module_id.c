...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860221" ";"
	"MOD:" "dml-test-bitfields_endian" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:41 2025";
extern void _initialize_T_bitfields_endian(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_bitfields_endian();
	init_local();
}
