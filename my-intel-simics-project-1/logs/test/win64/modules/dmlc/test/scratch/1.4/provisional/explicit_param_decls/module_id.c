...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860482" ";"
	"MOD:" "dml-test-explicit_param_decls" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:02 2025";
extern void _initialize_T_explicit_param_decls(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_explicit_param_decls();
	init_local();
}
