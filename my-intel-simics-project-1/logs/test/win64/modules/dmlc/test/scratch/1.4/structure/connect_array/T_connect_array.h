...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\connect_array\\T_connect_array.h"
...
struct __devstruct_0test_0c_0signal {
    void const  *val[2LL][3LL];
};
struct __devstruct_0test_0c {
    conf_object_t *obj[2LL][3LL];
    char const *port[2LL][3LL];
    struct __devstruct_0test_0c_0signal signal;
};
struct __devstruct_0test_0i {
    uint64 val;
};
struct __devstruct_0test_0j {
    uint64 val;
};
struct test {
    conf_object_t obj;
