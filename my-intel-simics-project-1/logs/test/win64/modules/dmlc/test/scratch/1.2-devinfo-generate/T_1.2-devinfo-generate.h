...
#ifndef T_1_2_DEVINFO_GENERATE_H
#define T_1_2_DEVINFO_GENERATE_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2-devinfo-generate\\T_1.2-devinfo-generate.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_1.2-devinfo-generate-struct.h"
...
struct __devstruct_0test_0b_0r1 {
    uint32 __DMLfield[4][2][2];
    uint8 f0[4][2][2];
    uint8 f1[4][2][2];
};
struct __devstruct_0test_0b {
    conf_object_t *_obj[4][2];
    _callback_vect_t _after_read_callbacks[4][2];
    _callback_vect_t _after_write_callbacks[4][2];
    _callback_vect_t _before_read_callbacks[4][2];
    _callback_vect_t _before_write_callbacks[4][2];
    conf_object_t *_cached_bank_obj[4][2];
    _connection_vect_t _connections[4][2];
    uint16 r0[4][2];
...
#endif /* not T_1_2_DEVINFO_GENERATE_H */
