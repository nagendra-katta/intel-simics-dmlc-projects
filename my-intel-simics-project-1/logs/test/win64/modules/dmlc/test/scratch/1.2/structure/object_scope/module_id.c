...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860324" ";"
	"MOD:" "dml-test-object_scope" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:24 2025";
extern void _initialize_T_object_scope(void);
