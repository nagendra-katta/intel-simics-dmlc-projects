...
#ifndef T_TRAIT_ARRAY_H
#define T_TRAIT_ARRAY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\trait_array\\T_trait_array.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_trait_array-struct.h"
...
struct __devstruct_0test_0pa1 {
    conf_object_t *_obj[2LL][2LL];
    conf_object_t *_cached_port_obj[2LL][2LL];
};
struct __devstruct_0test_0pa2 {
    conf_object_t *_obj[3LL][2LL];
    conf_object_t *_cached_port_obj[3LL][2LL];
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0pa1 pa1;
    struct __devstruct_0test_0pa2 pa2;
};
