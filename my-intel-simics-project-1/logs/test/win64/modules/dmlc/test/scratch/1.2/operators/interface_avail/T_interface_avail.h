...
#ifndef T_INTERFACE_AVAIL_H
#define T_INTERFACE_AVAIL_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\interface_avail\\T_interface_avail.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_interface_avail-struct.h"
...
struct __devstruct_0test_0o1 {
    conf_object_t *obj;
    char *port;
    cycle_interface_t const *cycle;
    signal_interface_t const *signal;
};
struct __devstruct_0test_0o2 {
    conf_object_t *obj;
    char *port;
    cycle_interface_t const *cycle;
};
struct test {
    ...
    struct __devstruct_0test_0o1 o1;
    struct __devstruct_0test_0o2 o2;
};
