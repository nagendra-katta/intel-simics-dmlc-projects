...
#ifndef T_SUBSEQUENT_LOG_H
#define T_SUBSEQUENT_LOG_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\statements\\subsequent_log\\T_subsequent_log.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_subsequent_log-struct.h"

typedef _traitref_t name;
typedef _traitref_t st;
typedef _traitref_t x;
typedef _traitref_t y;
typedef _traitref_t z;
typedef _traitref_t at;
...
typedef _traitref_t __implicit_group__y__z;
typedef _traitref_t __implicit_group__st;
...
struct ___implicit_group__y__z {
    struct _group group;
    struct _y y;
    struct _z z;
};
struct ___implicit_group__st {
    struct _group group;
    struct _st st;
};
...
struct __devstruct_0test_0test {
    bool val;
};
struct __devstruct_0test_1test_arrays {
    bool val;
};
struct __devstruct_0test_2test_critical_once {
    bool val;
};
struct __devstruct_0test_2test_error_once {
    bool val;
};
struct __devstruct_0test_2test_multi_inheritance {
    bool val;
};
struct __devstruct_0test_2test_warning_once {
    bool val;
};
struct test {
    conf_object_t obj;
    ...
    int multiply_inherited_count;
    struct __devstruct_0test_0test test;
    struct __devstruct_0test_1test_arrays test_arrays;
    struct __devstruct_0test_2test_critical_once test_critical_once;
    struct __devstruct_0test_2test_error_once test_error_once;
    struct __devstruct_0test_2test_multi_inheritance test_multi_inheritance;
    struct __devstruct_0test_2test_warning_once test_warning_once;
};
