...
#ifndef T_FIELD_ORDER_H
#define T_FIELD_ORDER_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\registers\\field_order\\T_field_order.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_field_order-struct.h"
...
struct __devstruct_0test_0b_0order {
    uint32 __DMLfield[2];
    int last_msb[2];
    uint8 a[2][3];
    uint8 b[2][3];
...
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_0order order;
};
struct test {
    conf_object_t obj;
