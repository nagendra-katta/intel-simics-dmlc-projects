...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\attributes\\T_attributes.h"
...
struct __devstruct_0test_0f2 {
    double val;
};
struct __devstruct_0test_0i {
    int64 val;
};
struct __devstruct_0test_0i2 {
    int64 val;
};
struct __devstruct_0test_1overridden_init {
    bool val;
};
struct __devstruct_0test_0u {
    uint64 val;
};
struct __devstruct_0test_0u2 {
    uint64 val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0f2 f2;
    struct __devstruct_0test_0i i;
    struct __devstruct_0test_0i2 i2;
    struct __devstruct_0test_1overridden_init overridden_init;
    struct __devstruct_0test_0u u;
    struct __devstruct_0test_0u2 u2;
};
