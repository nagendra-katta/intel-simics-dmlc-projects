...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860318" ";"
	"MOD:" "dml-test-event_in_connect" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:18 2025";
extern void _initialize_T_event_in_connect(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_event_in_connect();
	init_local();
}
