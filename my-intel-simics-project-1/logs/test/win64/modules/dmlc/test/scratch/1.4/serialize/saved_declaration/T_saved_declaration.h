...
#ifndef T_SAVED_DECLARATION_H
#define T_SAVED_DECLARATION_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_declaration\\T_saved_declaration.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_saved_declaration-struct.h"

typedef _traitref_t saved_template;
...
typedef _traitref_t mass_groups;
...
typedef struct inner_i_t inner_i_t;
typedef struct i_ii_t i_ii_t;
typedef struct inner_layout_t inner_layout_t;
struct inner_i_t {
    int i;
};
...
typedef struct _typeseq_2 _typeseq_2_t;


struct __devstruct_0test_0b_0r_0f {
    int v[4LL][3LL];
};
struct __devstruct_0test_0b_0r {
    int filler[4LL];
    uint64 val[4LL];
    struct __devstruct_0test_0b_0r_0f f;
};
struct __devstruct_0test_0b {
    conf_object_t *_obj[4LL];
    _callback_vect_t _after_read_callbacks[4LL];
    _callback_vect_t _after_write_callbacks[4LL];
    _callback_vect_t _before_read_callbacks[4LL];
    _callback_vect_t _before_write_callbacks[4LL];
    conf_object_t *_cached_bank_obj[4LL];
    _connection_vect_t _connections[4LL];
    int filler[4LL];
    struct __devstruct_0test_0b_0r r;
};
struct __devstruct_0test_0g_0s_0p {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    int saved_deep;
};
struct __devstruct_0test_0g_0s {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    struct __devstruct_0test_0g_0s_0p p;
};
struct __devstruct_0test_0g {
    struct __devstruct_0test_0g_0s s;
};
struct __devstruct_0test_0g1 {
    _dml_hook_t h1;
    _dml_hook_t h2;
    _dml_hook_t h3[4LL][2LL];
};
struct __devstruct_0test_0g2_0child {
    _dml_hook_t h1[3LL];
    _dml_hook_t h2[3LL];
    _dml_hook_t h3[3LL][4LL][2LL];
};
struct __devstruct_0test_0g2_0children {
    _dml_hook_t h1[3LL][5LL][7LL];
    _dml_hook_t h2[3LL][5LL][7LL];
    _dml_hook_t h3[3LL][5LL][7LL][4LL][2LL];
};
struct __devstruct_0test_0g2 {
    _dml_hook_t h1[3LL];
    _dml_hook_t h2[3LL];
    _dml_hook_t h3[3LL][4LL][2LL];
    struct __devstruct_0test_0g2_0child child;
    struct __devstruct_0test_0g2_0children children;
};
struct __devstruct_0test_0initial_0g1 {
    _dml_hook_t h1;
    _dml_hook_t h2;
    _dml_hook_t h3[4LL][2LL];
};
struct __devstruct_0test_0initial_0g2_0child {
    _dml_hook_t h1[3LL];
    _dml_hook_t h2[3LL];
    _dml_hook_t h3[3LL][4LL][2LL];
};
struct __devstruct_0test_0initial_0g2_0children {
    _dml_hook_t h1[3LL][5LL][7LL];
    _dml_hook_t h2[3LL][5LL][7LL];
    _dml_hook_t h3[3LL][5LL][7LL][4LL][2LL];
};
struct __devstruct_0test_0initial_0g2 {
    _dml_hook_t h1[3LL];
    _dml_hook_t h2[3LL];
    _dml_hook_t h3[3LL][4LL][2LL];
    struct __devstruct_0test_0initial_0g2_0child child;
    struct __devstruct_0test_0initial_0g2_0children children;
};
struct __devstruct_0test_0initial {
    struct __devstruct_0test_0initial_0g1 g1;
    struct __devstruct_0test_0initial_0g2 g2;
};
struct __devstruct_0test_1p_saved1 {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    int v;
};
struct __devstruct_0test_1p_saved2 {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    int v;
};
struct __devstruct_0test_1port_array_2array_saved_int {
    int s[4LL][3LL];
    int v[4LL][3LL];
};
struct __devstruct_0test_1port_array {
    conf_object_t *_obj[4LL];
    conf_object_t *_cached_port_obj[4LL];
    int s[4LL];
    int v[4LL];
    struct __devstruct_0test_1port_array_2array_saved_int array_saved_int;
};
struct test {
    conf_object_t obj;
    ...
    int saved_array[4LL];
    int64 saved_big_array[8LL][0x2000LL];
    uint32 saved_bitfields;
    bool saved_bool;
    uint8 saved_byte_array_via_data[4LL];
    uint8 saved_byte_array_via_list[4LL];
    float saved_float;
    _hookref_t saved_hookref_g1_h1;
    _hookref_t saved_hookref_g1_h2;
    _hookref_t saved_hookref_g1_h3_2_1;
    _hookref_t saved_hookref_g2_0_child_h1;
    _hookref_t saved_hookref_g2_0_child_h2;
    _hookref_t saved_hookref_g2_0_child_h3_2_1;
    _hookref_t saved_hookref_g2_1_children_2_4_h1;
    _hookref_t saved_hookref_g2_1_children_2_4_h2;
    _hookref_t saved_hookref_g2_1_children_2_4_h3_2_1;
    _hookref_t saved_hookref_g2_2_h1;
    _hookref_t saved_hookref_g2_2_h2;
    _hookref_t saved_hookref_g2_2_h3_2_1;
    _hookref_t saved_hookref_invalid_1;
    _hookref_t saved_hookref_invalid_2;
    _hookref_t saved_hookref_invalid_3;
    object saved_identity_device;
    object saved_identity_g1;
    object saved_identity_g2_0_child;
    object saved_identity_g2_1_children_2_4;
    object saved_identity_g2_2;
    object saved_identity_test;
    int saved_int;
    int32 saved_int24;
    int24_le_t saved_int24_le;
    struct _anon_struct_0 saved_layout;
    long saved_long;
    int saved_nested_array[4LL][3LL];
    uint8_be_t saved_nested_byte_array_via_data[4LL][3LL];
    uint8_be_t saved_nested_byte_array_via_list[4LL][3LL];
    int8_be_t saved_nested_signed_byte_array_via_data[4LL][3LL];
    int8_be_t saved_nested_signed_byte_array_via_list[4LL][3LL];
    char saved_signed_byte_array_via_data[4LL];
    char saved_signed_byte_array_via_list[4LL];
    size_t saved_size;
    struct _anon_struct_1 saved_struct;
    t saved_traitref_g1;
    t saved_traitref_g2_0_child;
    t saved_traitref_g2_1_children_2_4;
    t saved_traitref_g2_2;
    t saved_traitref_invalid;
    uint48_be_t saved_uint48_be;
    uint64_t saved_uint64_t;
    struct __devstruct_0test_0b b;
    struct __devstruct_0test_0g g;
    struct __devstruct_0test_0g1 g1;
    struct __devstruct_0test_0g2 g2;
    struct __devstruct_0test_0initial initial;
    struct __devstruct_0test_1p_saved1 p_saved1;
    struct __devstruct_0test_1p_saved2 p_saved2;
    struct __devstruct_0test_1port_array port_array;
};
...
#endif /* not T_SAVED_DECLARATION_H */
