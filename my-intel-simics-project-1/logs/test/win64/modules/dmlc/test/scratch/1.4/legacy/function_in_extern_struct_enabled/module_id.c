...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860417" ";"
	"MOD:" "dml-test-function_in_extern_struct_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:57 2025";
extern void _initialize_T_function_in_extern_struct_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_function_in_extern_struct_enabled();
	init_local();
}
