...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860298" ";"
	"MOD:" "dml-test-reserved" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:58 2025";
extern void _initialize_T_reserved(void);
