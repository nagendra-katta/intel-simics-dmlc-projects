...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860508" ";"
	"MOD:" "dml-test-name_parameter" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:28 2025";
extern void _initialize_T_name_parameter(void);
