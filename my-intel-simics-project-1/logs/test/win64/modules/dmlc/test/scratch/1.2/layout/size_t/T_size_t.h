...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\size_t\\T_size_t.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_size_t-struct.h"

typedef _traitref_t object;
typedef struct size_be_t size_be_t;
struct size_be_t {
    uint64_be_t member;
};
