...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860295" ";"
	"MOD:" "dml-test-read_constant" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:55 2025";
extern void _initialize_T_read_constant(void);
