...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860498" ";"
	"MOD:" "dml-test-nonconstant_compound_inits" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:18 2025";
extern void _initialize_T_nonconstant_compound_inits(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_nonconstant_compound_inits();
	init_local();
}
