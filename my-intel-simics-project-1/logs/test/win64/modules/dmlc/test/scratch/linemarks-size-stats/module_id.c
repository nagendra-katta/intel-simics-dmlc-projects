...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860161" ";"
	"MOD:" "dml-test-linemarks-size-stats" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:52:41 2025";
extern void _initialize_T_linemarks_size_stats(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_linemarks_size_stats();
	init_local();
}
