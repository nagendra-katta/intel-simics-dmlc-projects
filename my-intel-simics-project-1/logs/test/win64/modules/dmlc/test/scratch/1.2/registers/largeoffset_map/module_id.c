...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860286" ";"
	"MOD:" "dml-test-largeoffset_map" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:46 2025";
extern void _initialize_T_largeoffset_map(void);
