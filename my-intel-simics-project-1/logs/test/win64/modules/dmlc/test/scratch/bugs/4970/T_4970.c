 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\bugs\T_4970.dml
...
#include "T_4970.h"
#include "T_4970-protos.c"

static set_error_t set_nand_flash(conf_object_t *_obj, attr_value_t *_val, lang_void *_aux)
{
    ...
    #line 302 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    {
        ...
        #line 1686 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        {
            ...
            #line 1702 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            if (v7_obj == _dev->nand_flash.obj && ((v7_port == (NULL) && _dev->nand_flash.port == (NULL)) || ((v7_port != (NULL) && _dev->nand_flash.port != (NULL)) && strcmp(v7_port, _dev->nand_flash.port) == 0)))
            #line 1705 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            goto exit2;
            #line 1707 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            char *v7_old_port UNUSED  = _dev->nand_flash.port;
            ...
            #line 1710 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            {
                ...
                #line 1715 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                _dev->nand_flash.port = v7_new_port;
                {
                    #line 1677 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                ...
                _dev->nand_flash.port = v7_old_port;
                if (!v9_valid)
                goto throw1;
                #line 1721 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                {
                ...
                #line 1727 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                {
                    ...
                    #line 1770 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                    {
                        ...
                        if (v19_port != NULL)
                        v21_iface = SIM_c_get_port_interface(v19_obj, "nand_flash", v19_port);
                        else
                        v21_iface = SIM_c_get_interface(v19_obj, "nand_flash");
                        #line 1777 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                        if (v21_iface == (NULL))
                        #line 1777 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                        {
                            if (v19_port != NULL)
                            SIM_LOG_ERROR(&_dev->obj, 0, "Interface '%s' not found for port '%s' in object '%s'", "nand_flash", v19_port, SIM_object_name(v19_obj));
                            #line 1782 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                            else
                            SIM_LOG_ERROR(&_dev->obj, 0, "The %s object does not implement the required %s interface", SIM_object_name(v19_obj), "nand_flash");
                            #line 1786 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                            goto throw1;
                        }
                    }
            ...
            #line 1744 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            {
                ...
                if (v27_obj != NULL)
                {
                    #line 1794 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                    if (v27_port != NULL)
                    _dev->nand_flash.nand_flash = SIM_c_get_port_interface(v27_obj, "nand_flash", v27_port);
                    else
                    _dev->nand_flash.nand_flash = SIM_c_get_interface(v27_obj, "nand_flash");
                    #line 1794 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                }
                #line 1798 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                else
                _dev->nand_flash.nand_flash = NULL;
                #line 1744 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            }
            #line 1746 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        }
    ...
    #line 222 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\bugs\\4970\\T_4970.c"
    return _status;
}

static attr_value_t get_nand_flash(conf_object_t *_obj, lang_void *_aux)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    attr_value_t _val0;
    ...
    #line 311 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    {
        ...
        if (_dev->nand_flash.port != NULL)
        #line 1749 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        {
            v36_value = SIM_alloc_attr_list(2);
            SIM_attr_list_set_item(&v36_value, 0, SIM_make_attr_object(_dev->nand_flash.obj));
            SIM_attr_list_set_item(&v36_value, 1, SIM_make_attr_string(_dev->nand_flash.port));
        }
        #line 1753 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        else
        v36_value = SIM_make_attr_object(_dev->nand_flash.obj);
        #line 1748 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        v33_value = v36_value;
        #line 311 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    }
...
static exception_type_t _DML_IFACE_io_memory__operation(conf_object_t *_obj, generic_transaction_t *mem_op, map_info_t map_info)
{
    ...
    {
        exception_type_t v39__ret_ex UNUSED  = 0;
        if (_DML_M_io_memory__operation(_dev, mem_op, map_info, &v39__ret_ex))
...
static const _id_info_t _id_infos[5] UNUSED = {
    ...
    {"", NULL, 0, 2},
    {"io_memory", NULL, 0, 3},
    {"nand_flash.nand_flash", NULL, 0, 4},
    {"nand_flash", NULL, 0, 5}
};
static ht_str_table_t _id_info_ht UNUSED = HT_STR_NULL(false);
static void * const _object_vtables[5] UNUSED = {(&_tr__dev__object), (&_tr__dev__object), (&_tr_io_memory__object), (&_tr_nand_flash_nand_flash__object), (&_tr_nand_flash__object)};
...
{
    #line 17 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\io-memory.dml"
    exception_type_t v57_ex UNUSED  = 0;
    v57_ex = 0x401;
    #line 43 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\io-memory.dml"
...
_initialize_T_4970(void)
{
    ...
    _DML_register_attribute(class, "nand_flash", get_nand_flash, NULL, set_nand_flash, NULL, Sim_Attr_Required, "o|[os]", "The nand-flash device the controller is connected to.\012\012Required interfaces: <iface>nand_flash</iface>.");
    {
...
static void __attribute__((optimize("O0"))) _initialize_traits0(void)
{
    ...
    _tinit_object(&_tr_nand_flash__object);
    _tinit_object(&_tr_nand_flash_nand_flash__object);
}
