...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860242" ";"
	"MOD:" "dml-test-array_set_3" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:02 2025";
extern void _initialize_T_array_set_3(void);
