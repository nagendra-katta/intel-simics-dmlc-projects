...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860254" ";"
	"MOD:" "dml-test-register_view_no_xml" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:14 2025";
extern void _initialize_T_register_view_no_xml(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_register_view_no_xml();
	init_local();
}
