...
#ifndef T_DEAD_METHODS_H
#define T_DEAD_METHODS_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\dead_methods\\T_dead_methods.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_dead_methods-struct.h"

typedef _traitref_t nothing;
...
struct _t {
    int *p;
    uint32 h;
    void  (*dead_abstract)(test_t *arg0, t arg1);
    void  (*dead_shared)(test_t *arg0, t arg1);
};
struct _attribute {
    struct __conf_attribute _conf_attribute;
...
static const uint64 _dml_loggroup_lg UNUSED = 1ULL;
static const uint64 _dml_loggroup_Register_Read UNUSED = 2ULL;
static const uint64 _dml_loggroup_Register_Write UNUSED = 4ULL;

void hard_reset_test(test_t *_obj);
void soft_reset_test(test_t *_obj);

#endif /* not T_DEAD_METHODS_H */
