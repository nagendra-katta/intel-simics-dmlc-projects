...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\basic\\T_basic.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_basic-struct.h"

typedef _traitref_t hookset;
typedef _traitref_t hookset_test;
...
typedef _traitref_t __implicit_hookset_set__hookset_test;
typedef uint16 bf_t;
...
struct _hookset_test {
    struct _hookset hookset;
    void  (*testhooks)(test_t *arg0, hookset_test arg1);
};
struct _name {
    char const **name;
};
...
struct ___implicit_hookset_set__hookset_test {
    struct _hookset_set hookset_set;
    struct _hookset_test hookset_test;
};
...
typedef struct _typeseq_4 _typeseq_4_t;

struct _after_on_hook_1_args {
    bf_t i;
};
struct _after_on_hook_3_args {
    bf_t i;
};
struct _after_on_hook_5_args {
    bf_t i;
};
