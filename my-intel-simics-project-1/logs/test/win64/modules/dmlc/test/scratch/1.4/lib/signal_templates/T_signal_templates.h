...
#ifndef T_SIGNAL_TEMPLATES_H
#define T_SIGNAL_TEMPLATES_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\signal_templates\\T_signal_templates.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_signal_templates-struct.h"
...
typedef _traitref_t __implicit_bool_attr__pseudo_attr;
...
struct ___implicit_bool_attr__pseudo_attr {
    struct _bool_attr bool_attr;
    struct _pseudo_attr pseudo_attr;
};



struct __devstruct_0test_0insig_0signal {
    bool high;
};
struct __devstruct_0test_0insig {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    struct __devstruct_0test_0insig_0signal signal;
};
struct __devstruct_0test_0outsig_0signal {
    void const  *val;
    bool high;
};
struct __devstruct_0test_0outsig {
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0outsig_0signal signal;
};
struct __devstruct_0test_1test_outsig {
    bool val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0insig insig;
    struct __devstruct_0test_0outsig outsig;
    struct __devstruct_0test_1test_outsig test_outsig;
};
...
#endif /* not T_SIGNAL_TEMPLATES_H */
