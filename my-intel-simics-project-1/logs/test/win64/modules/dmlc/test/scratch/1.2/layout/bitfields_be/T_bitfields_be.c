 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\layout\T_bitfields_be.dml
...
#include "T_bitfields_be.h"
#include "T_bitfields_be-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                    {
                        uint32 v11_x UNUSED  = 0x118;
                        bf_t v11_y UNUSED  = v11_x;
                        layout_t v11_l UNUSED ;
                        #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                        memset((void *)&v11_l, 0, sizeof(layout_t ));
                        dml_copy_uint32_be_t(&v11_l.f, dml_store_uint32_be_t((uint64 )v11_x));
                        uint16 v11_z UNUSED  = (uint16 )((uint32 )v11_y & 0xfff);
                        #line 27 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                        uint16 v11_w UNUSED  = (uint16 )v11_x;
                        #line 31 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                        v11_w = DML_combine_bits(v11_w, DML_combine_bits((uint16 )(v11_w & 0x3ff), 160, 224), 0x3ff);
                        #line 33 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                        SIM_LOG_INFO(1, &_dev->obj, 0, "y.a = %llu", (uint64 )((uint8 )(v11_y >> 3 & 127)));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "l.f.a = %llu", (uint64 )((uint8 )(dml_load_uint32_be_t(v11_l.f) >> 3 & 127)));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "z.a = %llu", (uint64 )((uint8 )(v11_z >> 4 & 255)));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "z.b = %llu", (uint64 )((uint8 )(v11_z & 15)));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "w.a = %llu", (uint64 )((uint16 )(v11_w & 0x3ff)));
                        #line 42 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                        v10_ok = (((((uint8 )(v11_y >> 3 & 127)) == 35 && ((uint8 )(dml_load_uint32_be_t(v11_l.f) >> 3 & 127)) == 35) && ((uint8 )(v11_z >> 4 & 255)) == 17) && ((uint8 )(v11_z & 15)) == 8) && ((uint16 )(v11_w & 0x3ff)) == 0x1b8;
                    }
                    #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_bitfields_be.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 143 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\bitfields_be\\T_bitfields_be.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_bitfields_be(void)
{
