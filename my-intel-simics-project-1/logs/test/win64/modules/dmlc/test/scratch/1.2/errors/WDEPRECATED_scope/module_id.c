...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860198" ";"
	"MOD:" "dml-test-WDEPRECATED_scope" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:18 2025";
extern void _initialize_T_WDEPRECATED_scope(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_WDEPRECATED_scope();
	init_local();
}
