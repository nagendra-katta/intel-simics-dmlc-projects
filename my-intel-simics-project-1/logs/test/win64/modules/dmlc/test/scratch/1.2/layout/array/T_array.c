 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\layout\T_array.dml
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    bool v10_ok UNUSED  = 0;
                    {
                        lt v11_l1 UNUSED ;
                        #line 19 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        memset((void *)&v11_l1, 0, sizeof(lt ));
                        uint8 *v11_l1p UNUSED  = (uint8 *)&v11_l1;
                        lt v11_l2[2] UNUSED ;
                        #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        memset((void *)&v11_l2, 0, sizeof(lt [2]));
                        uint8 *v11_l2p UNUSED  = (uint8 *)&v11_l2;
                        int v11_i UNUSED  = 0;
                        #line 25 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        for (v11_i = 0; v11_i < (uint64 )sizeof(v11_l1); (v11_i)++)
                        v11_l1p[v11_i] = v11_i;
                        #line 28 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        for (v11_i = 0; v11_i < (uint64 )sizeof(v11_l2); (v11_i)++)
                        v11_l2p[v11_i] = v11_i;
                        #line 31 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        SIM_LOG_INFO(1, &_dev->obj, 0, "l1.a[0] = %#.4llx", (uint64 )dml_load_uint16_be_t(v11_l1.a[0]));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "l2[0].a[0] = %#.4llx", (uint64 )dml_load_uint16_be_t(v11_l2[0].a[0]));
                        SIM_LOG_INFO(1, &_dev->obj, 0, "l2[1].a[0] = %#.4llx", (uint64 )dml_load_uint16_be_t(v11_l2[1].a[0]));
                        #line 61 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                        v10_ok = (((((((((((((((((((dml_load_uint16_be_t(v11_l1.a[0]) == 1 && dml_load_uint16_be_t(v11_l1.a[1]) == 0x203) && dml_load_uint16_be_t(v11_l1.b[0][0]) == 0x405) && dml_load_uint16_be_t(v11_l1.b[0][1]) == 0x607) && dml_load_uint16_be_t(v11_l1.b[1][0]) == 0xc0d) && dml_load_uint16_le_t(v11_l1.c[0].c) == 0x1514) && dml_load_uint16_le_t(v11_l1.c[1].c) == 0x1716) && dml_load_uint16_be_t(v11_l2[0].a[0]) == 1) && dml_load_uint16_be_t(v11_l2[0].a[1]) == 0x203) && dml_load_uint16_be_t(v11_l2[0].b[0][0]) == 0x405) && dml_load_uint16_be_t(v11_l2[0].b[0][1]) == 0x607) && dml_load_uint16_be_t(v11_l2[0].b[1][0]) == 0xc0d) && dml_load_uint16_le_t(v11_l2[0].c[0].c) == 0x1514) && dml_load_uint16_le_t(v11_l2[0].c[1].c) == 0x1716) && dml_load_uint16_be_t(v11_l2[1].a[0]) == 0x1819) && dml_load_uint16_be_t(v11_l2[1].a[1]) == 0x1a1b) && dml_load_uint16_be_t(v11_l2[1].b[0][0]) == 0x1c1d) && dml_load_uint16_be_t(v11_l2[1].b[0][1]) == 0x1e1f) && dml_load_uint16_be_t(v11_l2[1].b[1][0]) == 0x2425) && dml_load_uint16_le_t(v11_l2[1].c[0].c) == 0x2d2c) && dml_load_uint16_le_t(v11_l2[1].c[1].c) == 0x2f2e;
                    }
                    #line 17 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_array.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 144 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\array\\T_array.c"
    _val0 = v3_value;
    return _val0;
}
