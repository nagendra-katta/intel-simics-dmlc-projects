...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860315" ";"
	"MOD:" "dml-test-par_over_endian" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:15 2025";
extern void _initialize_T_par_over_endian(void);
