...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860232" ";"
	"MOD:" "dml-test-call_expr" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:52 2025";
extern void _initialize_T_call_expr(void);
