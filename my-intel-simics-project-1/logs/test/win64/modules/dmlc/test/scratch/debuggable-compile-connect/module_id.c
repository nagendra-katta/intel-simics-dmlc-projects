...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860148" ";"
	"MOD:" "dml-test-debuggable-compile-connect" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:52:28 2025";
extern void _initialize_T_debuggable_compile_connect(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_debuggable_compile_connect();
	init_local();
}
