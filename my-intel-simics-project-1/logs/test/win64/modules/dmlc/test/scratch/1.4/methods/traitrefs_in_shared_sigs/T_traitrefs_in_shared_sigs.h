...
#ifndef T_TRAITREFS_IN_SHARED_SIGS_H
#define T_TRAITREFS_IN_SHARED_SIGS_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\methods\\traitrefs_in_shared_sigs\\T_traitrefs_in_shared_sigs.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_traitrefs_in_shared_sigs-struct.h"
...
struct _t {
    u (*downcast_with_fallback)(test_t *arg0, t arg1, u arg2);
};
struct _u {
    struct _t t;
};
...
#endif /* not T_TRAITREFS_IN_SHARED_SIGS_H */
