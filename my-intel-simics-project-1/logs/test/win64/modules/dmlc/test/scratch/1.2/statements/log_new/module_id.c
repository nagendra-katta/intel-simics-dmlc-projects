...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860303" ";"
	"MOD:" "dml-test-log_new" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:03 2025";
extern void _initialize_T_log_new(void);
