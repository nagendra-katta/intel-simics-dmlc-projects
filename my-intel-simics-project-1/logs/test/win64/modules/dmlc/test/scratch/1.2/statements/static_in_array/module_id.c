...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860307" ";"
	"MOD:" "dml-test-static_in_array" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:07 2025";
extern void _initialize_T_static_in_array(void);
