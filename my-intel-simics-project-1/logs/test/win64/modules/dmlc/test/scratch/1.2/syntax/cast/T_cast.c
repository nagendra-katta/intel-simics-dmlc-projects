 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\syntax\T_cast.dml
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        int v11_i UNUSED  = 0;
                        int *v11_ip UNUSED  = &v11_i;
                        int const *v11_cip UNUSED  = (int const *)&v11_i;
                        v11_ip = &v11_i;
                        v10_ok = 1;
                    }
                    #line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_cast.dml"
    ...
    #line 128 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\syntax\\cast\\T_cast.c"
    _val0 = v3_value;
    return _val0;
}
