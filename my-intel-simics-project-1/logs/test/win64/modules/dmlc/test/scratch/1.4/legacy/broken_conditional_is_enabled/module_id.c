...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860413" ";"
	"MOD:" "dml-test-broken_conditional_is_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:53 2025";
extern void _initialize_T_broken_conditional_is_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_broken_conditional_is_enabled();
	init_local();
}
