...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860339" ";"
	"MOD:" "dml-test-c_function_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:39 2025";
extern void _initialize_T_c_function_1(void);
