...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\connect\\T_connect.h"
...
struct __devstruct_0test_0a2_0b2_0c2_0d {
    conf_object_t *obj[2LL][3LL][5LL][7LL];
    char const *port[2LL][3LL][5LL][7LL];
};
struct __devstruct_0test_0a2_0b2_0c2 {
    struct __devstruct_0test_0a2_0b2_0c2_0d d;
};
struct __devstruct_0test_0a2_0b2 {
    conf_object_t *_obj[2LL][3LL];
    _callback_vect_t _after_read_callbacks[2LL][3LL];
    _callback_vect_t _after_write_callbacks[2LL][3LL];
    _callback_vect_t _before_read_callbacks[2LL][3LL];
    _callback_vect_t _before_write_callbacks[2LL][3LL];
    conf_object_t *_cached_bank_obj[2LL][3LL];
    _connection_vect_t _connections[2LL][3LL];
    struct __devstruct_0test_0a2_0b2_0c2 c2;
};
struct __devstruct_0test_0a2_0e_0f {
    conf_object_t *obj[2LL];
    char const *port[2LL];
};
struct __devstruct_0test_0a2_0e {
    conf_object_t *_obj[2LL];
    conf_object_t *_cached_port_obj[2LL];
    struct __devstruct_0test_0a2_0e_0f f;
};
struct __devstruct_0test_0a2_0p_0q {
    conf_object_t *obj[2LL];
    char const *port[2LL];
};
struct __devstruct_0test_0a2_0p {
    conf_object_t *_obj[2LL];
    conf_object_t *_cached_port_obj[2LL];
    struct __devstruct_0test_0a2_0p_0q q;
};
struct __devstruct_0test_0a2 {
    conf_object_t *_obj[2LL];
    conf_object_t *_cached_port_obj[2LL];
    struct __devstruct_0test_0a2_0b2 b2;
    struct __devstruct_0test_0a2_0e e;
    struct __devstruct_0test_0a2_0p p;
};
struct __devstruct_0test_0ifaces_1ethernet_cable {
    void const  *val;
};
struct __devstruct_0test_0ifaces_1ethernet_common {
    void const  *val;
};
struct __devstruct_0test_0ifaces_0signal {
    void const  *val;
};
struct __devstruct_0test_0ifaces {
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0ifaces_1ethernet_cable ethernet_cable;
    struct __devstruct_0test_0ifaces_1ethernet_common ethernet_common;
    struct __devstruct_0test_0ifaces_0signal signal;
};
struct __devstruct_0test_0noconf_0signal {
    void const  *val;
};
struct __devstruct_0test_0noconf {
    conf_object_t *obj;
    char const *port;
    struct __devstruct_0test_0noconf_0signal signal;
};
struct __devstruct_0test_0sub_0renamed_0signal {
    void const  *val[2LL];
};
struct __devstruct_0test_0sub_0renamed {
    conf_object_t *obj[2LL];
    char const *port[2LL];
    struct __devstruct_0test_0sub_0renamed_0signal signal;
};
struct __devstruct_0test_0sub {
    struct __devstruct_0test_0sub_0renamed renamed;
};
struct __devstruct_0test_0validate {
    conf_object_t *obj;
    char const *port;
};
struct test {
    ...
    struct __devstruct_0test_0ifaces ifaces;
    struct __devstruct_0test_0noconf noconf;
    struct __devstruct_0test_0sub sub;
    struct __devstruct_0test_0validate validate;
};
