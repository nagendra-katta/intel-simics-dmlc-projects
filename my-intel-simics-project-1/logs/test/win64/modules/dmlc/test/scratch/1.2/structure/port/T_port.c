 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\structure\T_port.dml
...
#include "T_port.h"
#include "T_port-protos.c"

static set_error_t set_p_last_irq(conf_object_t *_obj, attr_value_t *_val, lang_void *_aux)
{
    ...
    #line 302 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    {
        ...
        v6_err = 0;
        #line 379 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        if (_DML_M_p__last_irq__before_set(_dev))
        #line 379 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        goto throw1;
        if (_DML_M_p__last_irq__set(_dev, v6_value))
        #line 380 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        goto throw1;
        if (_DML_M_p__last_irq__after_set(_dev))
        #line 381 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        goto throw1;
        #line 383 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        if (false) throw1:
    ...
    #line 114 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\port\\T_port.c"
    return _status;
}

static attr_value_t get_p_last_irq(conf_object_t *_obj, lang_void *_aux)
{
     _port_object_t *_portobj = (_port_object_t *)_obj;
    test_t *_dev UNUSED = (test_t*)_portobj->dev;
    attr_value_t _val0;
    ...
    #line 311 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    {
        ...
        memset((void *)&v17_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 351 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            v19_value = SIM_make_attr_uint64(_dev->p.last_irq);
            #line 345 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            v17_value = v19_value;
            #line 387 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        }
...
static void  _DML_PIFACE_p__simple_interrupt__interrupt(conf_object_t *_obj, int irq)
{
    _port_object_t *_portobj = (_port_object_t *)_obj;
    test_t *_dev UNUSED = (test_t *)_portobj->dev;
    if (_DML_M_p__simple_interrupt__interrupt(_dev, irq))
    SIM_LOG_ERROR(_dev->p._obj, 0, "Uncaught DML exception");
}

static void  _DML_IFACE_p__simple_interrupt__interrupt(conf_object_t *_obj, int irq)
{
...
static const _id_info_t _id_infos[4] UNUSED = {
    {"dev", NULL, 0, 1},
    {"p.last_irq", NULL, 0, 2},
    {"p.simple_interrupt", NULL, 0, 3},
    {"p", NULL, 0, 4}
};
static ht_str_table_t _id_info_ht UNUSED = HT_STR_NULL(false);
static void * const _object_vtables[4] UNUSED = {(&_tr__dev__object), (&_tr_p_last_irq__object), (&_tr_p_simple_interrupt__object), (&_tr_p__object)};
...
/* p.simple_interrupt.interrupt */
static bool _DML_M_p__simple_interrupt__interrupt(test_t *_dev, int irq)
#line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\structure\\\\T_port.dml"
{
    SIM_LOG_INFO(1, _dev->p._obj, 0, "p.simple_interrupt interrupt %lld", (uint64 )irq);
    _dev->p.last_irq = irq;
    return 0;
    #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\structure\\\\T_port.dml"
}
...
/* p.last_irq.after_set */
static bool _DML_M_p__last_irq__after_set(test_t *_dev)
#line 297 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    return 0;
    #line 298 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
/* p.last_irq.set */
static bool _DML_M_p__last_irq__set(test_t *_dev, attr_value_t value)
#line 359 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 365 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    _dev->p.last_irq = SIM_attr_integer(value);
    #line 375 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
    #line 375 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
}
...
/* p.last_irq.before_set */
static bool _DML_M_p__last_irq__before_set(test_t *_dev)
#line 294 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    return 0;
    #line 295 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
_initialize_T_port(void)
{
    ...
    _register_port_attr(class, _port_class_p, offsetof(test_t, p._obj), false, "p", "last_irq", get_p_last_irq, set_p_last_irq, Sim_Attr_Optional|Sim_Attr_Internal, "i", "Undocumented");
    {
        static const simple_interrupt_interface_t simple_interrupt_interface = {
        .interrupt = &_DML_PIFACE_p__simple_interrupt__interrupt,
    };
        SIM_register_interface(_port_class_p, "simple_interrupt", &simple_interrupt_interface);
        static const simple_interrupt_interface_t port_iface = {
        .interrupt = &_DML_IFACE_p__simple_interrupt__interrupt,
    };
        SIM_register_port_interface(class, "simple_interrupt", &port_iface, "p", NULL);
    }
...
static void __attribute__((optimize("O0"))) _initialize_traits0(void)
{
    ...
    _tinit_object(&_tr_p_last_irq__object);
    _tinit_object(&_tr_p_simple_interrupt__object);
}
