...
#ifndef T_WHOOKSEND_H
#define T_WHOOKSEND_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\errors\\WHOOKSEND\\T_WHOOKSEND.h"
...
typedef struct substruct_t substruct_t;
...
struct struct_t {
    ...
    int *z[2LL][3LL];
    substruct_t sub_a;
    substruct_t sub_b[2LL];
    substruct_t sub_c[2LL][3LL];
};
...
typedef struct _typeseq_0 _typeseq_0_t;

struct _immediate_after_0_args {
    _hookref_t hookref;
    struct _typeseq_0 args;
};
