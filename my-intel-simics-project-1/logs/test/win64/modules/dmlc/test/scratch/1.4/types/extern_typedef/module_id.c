...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860522" ";"
	"MOD:" "dml-test-extern_typedef" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:42 2025";
extern void _initialize_T_extern_typedef(void);
