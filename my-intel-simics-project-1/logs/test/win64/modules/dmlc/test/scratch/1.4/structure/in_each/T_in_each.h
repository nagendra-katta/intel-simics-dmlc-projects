...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\in_each\\T_in_each.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_in_each-struct.h"

typedef _traitref_t x_1;
typedef _traitref_t x;
typedef _traitref_t y;
typedef _traitref_t a;
typedef _traitref_t b;
typedef _traitref_t foo;
typedef _traitref_t bar;
...
struct __devstruct_0test_0b_0g1_0r {
    uint64 val;
};
struct __devstruct_0test_0b_0g1 {
    struct __devstruct_0test_0b_0g1_0r r;
};
...
struct __devstruct_0test_0b3_0r {
    uint64 val;
};
struct __devstruct_0test_0b3 {
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0b3_0r r;
};
struct __devstruct_0test_0cond_0f_0r {
    uint64 val;
};
struct __devstruct_0test_0cond_0f {
    struct __devstruct_0test_0cond_0f_0r r;
};
struct __devstruct_0test_0cond_0t_0r {
    uint64 val;
};
struct __devstruct_0test_0cond_0t {
    struct __devstruct_0test_0cond_0t_0r r;
};
struct __devstruct_0test_0cond {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0cond_0f f;
    struct __devstruct_0test_0cond_0t t;
};
struct __devstruct_0test_0nested {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct test {
    ...
    struct __devstruct_0test_0cond cond;
    struct __devstruct_0test_0nested nested;
