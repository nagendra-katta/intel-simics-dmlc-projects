...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\trait\\T_trait.h"
...
#define DMLDIR_T_TRAIT_H "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\structure\\T_trait.h"
...
#line 432 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\trait\\T_trait.h"
#undef DMLDIR_T_TRAIT_H


#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_trait-struct.h"

typedef _traitref_t base;
typedef _traitref_t child;
typedef _traitref_t byte_params;
typedef _traitref_t marker;
typedef _traitref_t seqs;
typedef _traitref_t deep_const;
...
struct _base {
    ...
    uint32 d;
    uint32 e;
    int (*m)(test_t *arg0, base arg1, int arg2);
};
struct _child {
    struct _base base;
    int (*n)(test_t *arg0, child arg1, int arg2, int *arg3);
};
struct _byte_params {
    uint8 *aa;
    uint8 *ab;
