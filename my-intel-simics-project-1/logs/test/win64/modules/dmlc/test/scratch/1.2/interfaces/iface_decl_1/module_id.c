...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860212" ";"
	"MOD:" "dml-test-iface_decl_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:32 2025";
extern void _initialize_T_iface_decl_1(void);
