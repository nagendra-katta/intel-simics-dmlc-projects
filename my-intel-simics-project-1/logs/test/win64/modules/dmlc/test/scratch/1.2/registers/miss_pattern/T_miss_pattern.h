...
#ifndef T_MISS_PATTERN_H
#define T_MISS_PATTERN_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\registers\\miss_pattern\\T_miss_pattern.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_miss_pattern-struct.h"
...
struct __devstruct_0test_0ob_0g {
    uint16 a[2][2];
    uint16 b[2];
};
struct __devstruct_0test_0ob {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0ob_0g g;
    uint16 r2;
    uint16 r21;
    uint16 r25;
    uint16 r6;
...
struct __devstruct_0test_0pb_0g {
    uint16 a[2][2];
    uint16 b[2];
};
struct __devstruct_0test_0pb {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0pb_0g g;
    uint16 r2;
    uint16 r21;
    uint16 r25;
    uint16 r6;
...
struct test {
    ...
    struct __devstruct_0test_0f f;
    struct __devstruct_0test_0ob ob;
    struct __devstruct_0test_0pb pb;
    struct __devstruct_0test_0t t;
    struct __devstruct_0test_0tb tb;
};
