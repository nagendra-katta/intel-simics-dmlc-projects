...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860163" ";"
	"MOD:" "dml-test-1.2-devinfo-generate" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:52:43 2025";
extern void _initialize_T_1_2_devinfo_generate(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_1_2_devinfo_generate();
	init_local();
}
