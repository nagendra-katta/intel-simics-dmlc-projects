...
#ifndef T_STATIC_INDEXED_H
#define T_STATIC_INDEXED_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\static_indexed\\T_static_indexed.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_static_indexed-struct.h"
...
struct __devstruct_0test_1x_regs {
    conf_object_t *_obj;
...
struct __devstruct_0test_1y_regs {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
...
struct test {
    ...
    struct __devstruct_0test_1x_regs x_regs;
    struct __devstruct_0test_1y_regs y_regs;
};
