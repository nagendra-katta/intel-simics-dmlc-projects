 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\serialize\T_saved_dead_vtable.dml
...
#include "T_saved_dead_vtable.h"
#include "T_saved_dead_vtable-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 111 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_dead_vtable\\T_saved_dead_vtable.c"
...
conf_class_t *
_initialize_T_saved_dead_vtable(void)
{
    ...
    _register_events(class);
    {
        const struct {
          ...
          const char *type;
            ...
            {"m_method_saved", "[s[i*]]"},
            {"m_method_saved_uninstantiated", "[s[i*]]"},
            {"object_saved", "[s[i*]]"},
            {"object_saved_uninstantiated", "[s[i*]]"},
        };
        static const _saved_userdata_t saved_userdata[4] = {
            {offsetof(test_t, static0_method_saved), 0, NULL, NULL, DML_deserialize_Tu, DML_serialize_T},
            {offsetof(test_t, static1_method_saved_uninstantiated), 0, NULL, NULL, DML_deserialize_Tuninstantiated_2, DML_serialize_T},
            {offsetof(test_t, object_saved), 0, NULL, NULL, DML_deserialize_Tt, DML_serialize_T},
            {offsetof(test_t, object_saved_uninstantiated), 0, NULL, NULL, DML_deserialize_Tuninstantiated_1, DML_serialize_T},
        };
...
static ht_int_table_t _uninstantiated_1_vtable_ht UNUSED = HT_INT_NULL();
static ht_int_table_t _u_vtable_ht UNUSED = HT_INT_NULL();
static ht_int_table_t _uninstantiated_2_vtable_ht UNUSED = HT_INT_NULL();
...
static const _vtable_list_t *const _each__uninstantiated_1 UNUSED = NULL;
static const _vtable_list_t *const _each__uninstantiated_2 UNUSED = NULL;
...
set_error_t DML_deserialize_Tuninstantiated_2(attr_value_t in, void  *_out) {
    uninstantiated_2 *out = (uninstantiated_2 *)_out;
    set_error_t _success UNUSED = Sim_Set_Ok;
    {
        set_error_t _sub_success;
        {
            _sub_success = _deserialize_trait_reference(&_id_info_ht, &_uninstantiated_2_vtable_ht, "uninstantiated_2", in, &(*out));
        }
        if (_sub_success != Sim_Set_Ok)
        {
            _success = _sub_success;
...
set_error_t DML_deserialize_Tuninstantiated_1(attr_value_t in, void  *_out) {
    uninstantiated_1 *out = (uninstantiated_1 *)_out;
    set_error_t _success UNUSED = Sim_Set_Ok;
    {
        set_error_t _sub_success;
        {
            _sub_success = _deserialize_trait_reference(&_id_info_ht, &_uninstantiated_1_vtable_ht, "uninstantiated_1", in, &(*out));
        }
        if (_sub_success != Sim_Set_Ok)
        {
            _success = _sub_success;
