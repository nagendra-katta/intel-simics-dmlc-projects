...
#ifndef T_NAME_PARAMETER_H
#define T_NAME_PARAMETER_H
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_name_parameter-struct.h"
...
struct __devstruct_0test_2BANK_NAME_OVERRIDDEN_2REG_NAME_OVERRIDDEN {
    uint64 val;
};
struct __devstruct_0test_2BANK_NAME_OVERRIDDEN {
    conf_object_t *_obj;
    ...
    struct __devstruct_0test_2BANK_NAME_OVERRIDDEN_2REG_NAME_OVERRIDDEN REG_NAME_OVERRIDDEN;
};
struct __devstruct_0test_0c_2NOT_THE_BANK {
    uint64 val;
};
struct __devstruct_0test_0c {
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0c_2NOT_THE_BANK NOT_THE_BANK;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_2BANK_NAME_OVERRIDDEN BANK_NAME_OVERRIDDEN;
