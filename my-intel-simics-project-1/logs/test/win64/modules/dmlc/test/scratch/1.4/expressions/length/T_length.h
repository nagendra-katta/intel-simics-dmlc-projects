...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\expressions\\length\\T_length.h"
...
struct __devstruct_0test_0b_0d {
    uint64 val[2LL][3LL][6LL];
};
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_0d d;
};
struct __devstruct_0test_0d {
    conf_object_t *_obj[3LL][6LL];
    conf_object_t *_cached_port_obj[3LL][6LL];
};
struct test {
    conf_object_t obj;
