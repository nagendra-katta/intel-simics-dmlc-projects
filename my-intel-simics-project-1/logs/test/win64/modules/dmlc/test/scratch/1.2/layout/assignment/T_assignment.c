 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\layout\T_assignment.dml
...
#include "T_assignment.h"
#include "T_assignment-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 13 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_assignment.dml"
                    {
                        uint8 v11_c[8] UNUSED ;
                        #line 14 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_assignment.dml"
                        memset((void *)&v11_c, 0, sizeof(uint8 [8]));
                        layout_type const *v11_p1 UNUSED  = (void  *)v11_c;
                        layout_type *v11_p2 UNUSED  = (void  *)v11_c;
                        #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_assignment.dml"
                        memset(v11_c, 0, sizeof(v11_c));
                        v11_c[0] = 71;
                        v11_c[7] = 17;
                        v10_ok = dml_load_uint64_be_t(v11_p1->val) == 0x4700000000000011ULL;
                        v10_ok = dml_load_uint64_be_t(v11_p2->val) == 0x4700000000000011ULL;
                        #line 24 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_assignment.dml"
                        layout_type v11_v UNUSED  = *v11_p1;
                        v10_ok = dml_load_uint64_be_t(v11_v.val) == 0x4700000000000011ULL;
                        v11_v = *v11_p2;
                        v10_ok = dml_load_uint64_be_t(v11_v.val) == 0x4700000000000011ULL;
                    }
                    #line 13 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\layout\\\\T_assignment.dml"
    ...
    #line 140 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\assignment\\T_assignment.c"
    _val0 = v3_value;
    return _val0;
}
