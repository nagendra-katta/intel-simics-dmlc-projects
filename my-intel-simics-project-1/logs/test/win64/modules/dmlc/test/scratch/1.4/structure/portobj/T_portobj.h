...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\structure\\portobj\\T_portobj.h"
...
struct __devstruct_0test_0p_0a {
    uint64 val[2LL];
};
struct __devstruct_0test_0p {
    conf_object_t *_obj[2LL];
    conf_object_t *_cached_port_obj[2LL];
    struct __devstruct_0test_0p_0a a;
};
struct __devstruct_0test_0x_0a {
    uint64 val;
};
struct __devstruct_0test_0x {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    struct __devstruct_0test_0x_0a a;
};
struct test {
    conf_object_t obj;
