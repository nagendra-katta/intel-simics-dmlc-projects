...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860346" ";"
	"MOD:" "dml-test-locals_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:46 2025";
extern void _initialize_T_locals_1(void);
