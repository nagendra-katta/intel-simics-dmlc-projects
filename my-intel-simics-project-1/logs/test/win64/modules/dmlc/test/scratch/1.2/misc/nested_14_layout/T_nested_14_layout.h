...
#ifndef T_NESTED_14_LAYOUT_H
#define T_NESTED_14_LAYOUT_H
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_nested_14_layout-struct.h"

typedef _traitref_t object;
typedef struct le_12_layout le_12_layout;
typedef struct be_nested_layout be_nested_layout;
struct le_12_layout {
    int24_le_t i24;
    int56_le_t a56[2];
};

struct be_nested_layout {
    uint24_be_t a;
    le_12_layout l;
    uint8_be_t b;
};
...
#endif /* not T_NESTED_14_LAYOUT_H */
