 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\operators\T_assign_type.dml
...
#include "T_assign_type.h"
#include "T_assign_type-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_assign_type.dml"
                    {
                        uint32 v11_x UNUSED  = 0x4d2;
                        v10_ok = 1;
                        v10_ok = v10_ok && (((v11_x = 15), (v11_x))) == 15;
                        v10_ok = v10_ok && (((v11_x = v11_x + 15), (v11_x))) == 30;
                        v10_ok = v10_ok && (((v11_x = (uint8 )(v11_x & 15)), (v11_x))) == 14;
                        v10_ok = v10_ok && (((v11_x = DML_combine_bits(v11_x, 12, 60)), ((uint8 )(v11_x >> 2 & 15)))) == 3;
                    }
                    #line 9 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\operators\\\\T_assign_type.dml"
                    v9_result = v10_ok;
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 130 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\operators\\assign_type\\T_assign_type.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_assign_type(void)
{
