 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\syntax\T_unicode.dml
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        v10_ok = 1;
                        SIM_LOG_INFO(1, &_dev->obj, 0, "I live on a sk\303\244rg\303\245rds\303\266");
                        #line 18 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_unicode.dml"
                        uint8 const *v11_s UNUSED  = (uint8 *)"\303\245";
                        if ((v11_s[0] != 195 || v11_s[1] != 165) || v11_s[2] != 0)
                        v10_ok = 0;
                    }
                    #line 13 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_unicode.dml"
                    v9_result = v10_ok;
    ...
    #line 130 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\syntax\\unicode\\T_unicode.c"
    _val0 = v3_value;
    return _val0;
}
...
_initialize_T_unicode(void)
{
    ...
    const class_info_t funcs = {
        ...
        .description = "\302\251 is not copyright\342\200\224but similar",
    };
