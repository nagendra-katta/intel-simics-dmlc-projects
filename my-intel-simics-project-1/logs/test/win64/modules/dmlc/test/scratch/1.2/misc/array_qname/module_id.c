...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860240" ";"
	"MOD:" "dml-test-array_qname" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:00 2025";
extern void _initialize_T_array_qname(void);
