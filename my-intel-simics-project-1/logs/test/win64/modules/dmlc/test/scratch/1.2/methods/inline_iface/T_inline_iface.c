 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\methods\T_inline_iface.dml
...
#include "T_inline_iface.h"
#include "T_inline_iface-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 128 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\methods\\inline_iface\\T_inline_iface.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_inline_iface(void)
{
