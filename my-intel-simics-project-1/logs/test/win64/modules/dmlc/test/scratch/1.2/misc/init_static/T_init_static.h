...
#ifndef T_INIT_STATIC_H
#define T_INIT_STATIC_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\init_static\\T_init_static.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_init_static-struct.h"
...
struct test {
    conf_object_t obj;
    int static0_simple_array[4];
    int static1_d2_array[2][4];
    char const *static2_str_array[2];
    struct _anon_struct_0 static3_simple_struct;
    struct _anon_struct_1 static4_a_struct_array[2];
    struct _anon_struct_2 static5_b_struct;
    uint32 static6_bf;
