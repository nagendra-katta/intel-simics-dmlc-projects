...
#ifndef T_CONNECTS_IN_PORT_ARRAY_H
#define T_CONNECTS_IN_PORT_ARRAY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\connects_in_port_array\\T_connects_in_port_array.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_connects_in_port_array-struct.h"
...
struct __devstruct_0test_0b_0c {
    conf_object_t *obj[2][2][2];
    char *port[2][2][2];
    signal_interface_t const *signal[2][2][2];
};
struct __devstruct_0test_0b {
    conf_object_t *_obj[2][2];
    _callback_vect_t _after_read_callbacks[2][2];
    _callback_vect_t _after_write_callbacks[2][2];
    _callback_vect_t _before_read_callbacks[2][2];
    _callback_vect_t _before_write_callbacks[2][2];
    conf_object_t *_cached_bank_obj[2][2];
    _connection_vect_t _connections[2][2];
    struct __devstruct_0test_0b_0c c;
};
struct __devstruct_0test_0p_0c {
    conf_object_t *obj[2][2][2];
    char *port[2][2][2];
    signal_interface_t const *signal[2][2][2];
};
struct __devstruct_0test_0p {
    conf_object_t *_obj[2][2];
    struct __devstruct_0test_0p_0c c;
};
struct test {
    conf_object_t obj;
...
#endif /* not T_CONNECTS_IN_PORT_ARRAY_H */
