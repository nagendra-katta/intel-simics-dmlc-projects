...
#ifndef T_CANCELLATION_H
#define T_CANCELLATION_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\hooks\\cancellation\\T_cancellation.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_cancellation-struct.h"

typedef _traitref_t domain;
...
struct _domain {
    uint32 count;
    void  (*post_after_on_hook)(test_t *arg0, domain arg1);
};
struct _name {
    char const **name;
};
