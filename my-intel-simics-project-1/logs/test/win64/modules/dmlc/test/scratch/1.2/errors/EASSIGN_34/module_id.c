...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860177" ";"
	"MOD:" "dml-test-EASSIGN_34" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:52:57 2025";
extern void _initialize_T_EASSIGN_34(void);
