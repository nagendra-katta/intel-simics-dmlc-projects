...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860483" ";"
	"MOD:" "dml-test-simics_util_vect" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:03 2025";
extern void _initialize_T_simics_util_vect(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_simics_util_vect();
	init_local();
}
