...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\types\\typedef\\T_typedef.h"
...
typedef struct t0_t t0_t;
typedef struct t1_t t1_t;
typedef struct t2_t t2_t;
typedef struct x_t x_t;
typedef struct y_t y_t;
typedef struct X X;
typedef struct Z Z;
typedef const struct cx_t cx_t;
struct t0_t {
    uint8 a;
};
