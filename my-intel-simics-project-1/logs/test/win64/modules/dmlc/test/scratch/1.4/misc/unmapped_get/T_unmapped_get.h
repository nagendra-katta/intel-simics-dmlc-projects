...
#ifndef T_UNMAPPED_GET_H
#define T_UNMAPPED_GET_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\misc\\unmapped_get\\T_unmapped_get.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_unmapped_get-struct.h"
...
typedef _traitref_t __implicit_miss_pattern_bank__test_bank;
...
struct ___implicit_miss_pattern_bank__test_bank {
    ...
    struct _test_bank test_bank;
};



struct __devstruct_0test_1_default {
    conf_object_t *_obj;
...
struct __devstruct_0test_0overload_0r1 {
    uint64 val;
};
struct __devstruct_0test_0overload_0r2 {
    uint64 val;
};
struct __devstruct_0test_0overload {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0overload_0r1 r1;
    struct __devstruct_0test_0overload_0r2 r2;
};
struct __devstruct_0test_0pattern_0r1 {
    uint64 val;
};
struct __devstruct_0test_0pattern_0r2 {
    uint64 val;
};
struct __devstruct_0test_0pattern {
    conf_object_t *_obj;
    _callback_vect_t _after_read_callbacks;
    _callback_vect_t _after_write_callbacks;
    _callback_vect_t _before_read_callbacks;
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0pattern_0r1 r1;
    struct __devstruct_0test_0pattern_0r2 r2;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_1_default _default;
    struct __devstruct_0test_0overload overload;
    struct __devstruct_0test_0pattern pattern;
};
