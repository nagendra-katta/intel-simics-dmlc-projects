...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860539" ";"
	"MOD:" "dml-test-lib-dml-1.4-api-6" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:59 2025";
extern void _initialize_T_lib_dml_1_4_api_6(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_lib_dml_1_4_api_6();
	init_local();
}
