...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\errors\\WPCAST\\T_WPCAST.h"
...
typedef struct layout_a_t layout_a_t;
typedef struct layout_b_t layout_b_t;
struct layout_a_t {
    uint32_le_t x;
};
