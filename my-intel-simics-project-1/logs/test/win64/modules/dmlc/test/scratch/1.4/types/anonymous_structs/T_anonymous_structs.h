...
#ifndef T_ANONYMOUS_STRUCTS_H
#define T_ANONYMOUS_STRUCTS_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\types\\anonymous_structs\\T_anonymous_structs.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_anonymous_structs-struct.h"
...
struct t11 {
    struct _anon_struct_0 *s[2LL];
};

struct t13 {
    struct _anon_struct_1 *s[2LL];
};
...
struct _anon_struct_3 {
    uint8 c[9LL];
};
struct _anon_struct_4 {
    uint8 c[3LL];
};
struct _anon_struct_5 {
    uint8 c[7LL];
};
struct _anon_struct_6 {
    uint8 c[5LL];
};
struct _anon_struct_7 {
    uint8 c[9LL];
};
struct _anon_struct_9 {
    uint8 c[17LL];
};
struct _anon_struct_10 {
    uint8 c[19LL];
};
...
struct test {
    conf_object_t obj;
    struct _anon_struct_9 static0_v17;
    struct _anon_struct_10 static1_v19;
    ...
    struct _anon_struct_4 v3;
    struct _anon_struct_5 v7;
    struct _anon_struct_6 v5;
    struct _anon_struct_7 v9;
};
...
#endif /* not T_ANONYMOUS_STRUCTS_H */
