 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\misc\T_init_static.dml
...
#include "T_init_static.h"
#include "T_init_static-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
        ...
        memset((void *)&v6_value, 0, sizeof(attr_value_t ));
        {
            ...
            #line 21 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
            {
                bool v9_result UNUSED  = 1;
                {
                    ...
                    {
                        #line 15 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = ((_dev->static0_simple_array[0] == 0 && _dev->static0_simple_array[1] == 0x100) && _dev->static0_simple_array[2] == 128) && _dev->static0_simple_array[3] == 0x1000;
                        if (!v10_ok)
                        goto exit4;
                        #line 30 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = ((((((_dev->static1_d2_array[0][0] == 1 && _dev->static1_d2_array[0][1] == 2) && _dev->static1_d2_array[0][2] == 3) && _dev->static1_d2_array[0][3] == 4) && _dev->static1_d2_array[1][0] == 5) && _dev->static1_d2_array[1][1] == 6) && _dev->static1_d2_array[1][2] == 7) && _dev->static1_d2_array[1][3] == 8;
                        if (!v10_ok)
                        goto exit4;
                        #line 40 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = ((_dev->static2_str_array[0][0] == 65 && _dev->static2_str_array[0][1] == 0) && _dev->static2_str_array[1][0] == 66) && _dev->static2_str_array[1][1] == 0;
                        if (!v10_ok)
                        goto exit4;
                        #line 49 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = _dev->static3_simple_struct.i == 42 && _dev->static3_simple_struct.b == 1;
                        if (!v10_ok)
                        goto exit4;
                        #line 57 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = _dev->static4_a_struct_array[0].i == 11 && _dev->static4_a_struct_array[1].i == 12;
                        if (!v10_ok)
                        goto exit4;
                        #line 65 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = _dev->static5_b_struct.a[0] == 9 && _dev->static5_b_struct.a[1] == 10;
                        if (!v10_ok)
                        goto exit4;
                        #line 75 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        uint32 v11_bf_v UNUSED  = _dev->static6_bf;
                        #line 79 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\misc\\\\T_init_static.dml"
                        v10_ok = ((((uint8 )(_dev->static6_bf >> 29 & 7)) == 2 && ((uint16 )((uint16 )(_dev->static6_bf >> 8 & 0xffff))) == 0x1234) && ((uint8 )((uint8 )(_dev->static6_bf & 255))) == 204) && v11_bf_v == 0x401234cc;
                        if (!v10_ok)
                        goto exit4;
                    }
                    #line 23 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\testing.dml"
    ...
    #line 156 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\init_static\\T_init_static.c"
    _val0 = v3_value;
    return _val0;
}
...
conf_class_t *
_initialize_T_init_static(void)
{
...
{
    memcpy((void *)_dev->static0_simple_array, (int [4]){0, 0x100, 128, 0x1000}, sizeof _dev->static0_simple_array);
    memcpy((void *)_dev->static1_d2_array, (int [2][4]){{1, 2, 3, 4}, {5, 6, 7, 8}}, sizeof _dev->static1_d2_array);
    memcpy((void *)_dev->static2_str_array, (char const *[2]){"A", "B"}, sizeof _dev->static2_str_array);
    memcpy((void *)&_dev->static3_simple_struct, (struct _anon_struct_0 [1]){{42, 1}}, sizeof _dev->static3_simple_struct);
    memcpy((void *)_dev->static4_a_struct_array, (struct _anon_struct_1 [2]){{11}, {12}}, sizeof _dev->static4_a_struct_array);
    memcpy((void *)&_dev->static5_b_struct, (struct _anon_struct_2 [1]){{{9, 10}}}, sizeof _dev->static5_b_struct);
    _dev->static6_bf = 0x401234cc;
}
