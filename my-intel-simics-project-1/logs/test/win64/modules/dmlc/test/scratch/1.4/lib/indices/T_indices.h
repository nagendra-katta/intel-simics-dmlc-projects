...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\indices\\T_indices.h"
...
struct __devstruct_0test_0c_0signal {
    void const  *val[2LL][2LL];
};
struct __devstruct_0test_0c {
    conf_object_t *obj[2LL][2LL];
    char const *port[2LL][2LL];
