...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\reset\\T_reset.h"
...
typedef _traitref_t __implicit__init_val_hard_reset___init_val_power_on_reset___init_val_soft_reset__unmapped;
typedef _traitref_t __implicit__init_val_hard_reset___init_val_power_on_reset___init_val_soft_reset___reg_read_as_field___reg_write_as_field__read__unmapped__write;
typedef _traitref_t __implicit__init_val_hard_reset___init_val_power_on_reset___init_val_soft_reset__soft_reset_val__unmapped;
typedef _traitref_t __implicit__init_val_hard_reset___init_val_power_on_reset___init_val_soft_reset___read_field___write_field__field__read__write;
...
struct ___implicit__init_val_hard_reset___init_val_power_on_reset___init_val_soft_reset__unmapped {
    ...
    struct __init_val_power_on_reset _init_val_power_on_reset;
...
struct __devstruct_0test_0POWER {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
};
...
struct test {
    ...
    struct __devstruct_0test_0POWER POWER;
