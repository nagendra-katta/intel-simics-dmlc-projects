...
#ifndef T_UNMAPPED_ACCESS_H
#define T_UNMAPPED_ACCESS_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\unmapped_access\\T_unmapped_access.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_unmapped_access-struct.h"
...
typedef _traitref_t partially_mapped_register;
typedef _traitref_t unmapped_bits_set;
typedef _traitref_t log_unmapped_bit_write;
...
typedef _traitref_t __implicit_log_unmapped_bit_write__partially_mapped_register__unmapped_bits_set;
typedef _traitref_t __implicit_log_unmapped_bit_write__unmapped__unmapped_bits_set;
...
struct _partially_mapped_register {
    struct _unmapped unmapped;
};
struct _unmapped_bits_set {
    struct __register _register;
};
struct _log_unmapped_bit_write {
    struct __register _register;
};
struct _implement {
    struct _object object;
...
struct ___implicit_log_unmapped_bit_write__partially_mapped_register__unmapped_bits_set {
    struct _log_unmapped_bit_write log_unmapped_bit_write;
    struct _partially_mapped_register partially_mapped_register;
    struct _unmapped_bits_set unmapped_bits_set;
};
struct ___implicit_log_unmapped_bit_write__unmapped__unmapped_bits_set {
    struct _log_unmapped_bit_write log_unmapped_bit_write;
    struct _unmapped unmapped;
    struct _unmapped_bits_set unmapped_bits_set;
};
...
struct __devstruct_0test_0b_1r1_2 {
    uint64 val;
};
...
struct __devstruct_0test_0b {
    ...
    struct __devstruct_0test_0b_1r1_2 r1_2;
...
struct test {
    ...
    void  *most_recent_aux;
    uint64 most_recent_mask;
    uint64 most_recent_val;
