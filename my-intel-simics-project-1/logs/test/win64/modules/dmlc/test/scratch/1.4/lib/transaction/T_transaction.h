...
#ifndef T_TRANSACTION_H
#define T_TRANSACTION_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\transaction\\T_transaction.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_transaction-struct.h"
...
struct test {
    conf_object_t obj;
    uint64 static0_multi_offset[4LL];
    uint64 static1_multi_value[4LL];
    uint64 static2_offset;
    uint64 static3_size;
    uint64 static4_value;
    uint64 static5_multi_offset[4LL];
    uint64 static6_multi_value[4LL];
    uint64 static7_offset;
    uint64 static8_value;
    uint64 static9_mask;
    uint64 static10_aux;
    uint64 static11_multi_offset[4LL];
    uint64 static12_offset;
    uint64 static13_size;
    uint64 static14_multi_offset[4LL];
    uint64 static15_offset;
    uint64 static16_mask;
    uint64 static17_aux;
    uint64 static18_multi_offset[4LL];
    uint64 static19_multi_value[4LL];
    uint64 static20_offset;
    uint64 static21_size;
    uint64 static22_value;
    uint64 static23_multi_offset[4LL];
    uint64 static24_multi_value[4LL];
    uint64 static25_offset;
    uint64 static26_value;
    uint64 static27_mask;
    uint64 static28_aux;
    uint64 static29_multi_offset[4LL];
    uint64 static30_offset;
    uint64 static31_size;
    uint64 static32_multi_offset[4LL];
    uint64 static33_offset;
    uint64 static34_mask;
    uint64 static35_aux;
