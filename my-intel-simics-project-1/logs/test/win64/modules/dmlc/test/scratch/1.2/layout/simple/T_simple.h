...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\simple\\T_simple.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_simple-struct.h"

typedef _traitref_t object;
typedef struct bedesc bedesc;
typedef struct ledesc ledesc;
struct bedesc {
    uint32_be_t a;
    uint16_be_t b;
    uint16_be_t c;
