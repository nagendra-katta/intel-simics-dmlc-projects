...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860313" ";"
	"MOD:" "dml-test-connect_obj" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:13 2025";
extern void _initialize_T_connect_obj(void);
