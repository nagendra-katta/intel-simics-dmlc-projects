...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860314" ";"
	"MOD:" "dml-test-connect_validate" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:14 2025";
extern void _initialize_T_connect_validate(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_connect_validate();
	init_local();
}
