...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860489" ";"
	"MOD:" "dml-test-saved_failure" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:09 2025";
extern void _initialize_T_saved_failure(void);
