...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860448" ";"
	"MOD:" "dml-test-partial_access_log" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:28 2025";
extern void _initialize_T_partial_access_log(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_partial_access_log();
	init_local();
}
