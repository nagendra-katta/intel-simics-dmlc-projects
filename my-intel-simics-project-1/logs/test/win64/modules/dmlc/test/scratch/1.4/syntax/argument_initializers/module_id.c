...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860515" ";"
	"MOD:" "dml-test-argument_initializers" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:35 2025";
extern void _initialize_T_argument_initializers(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_argument_initializers();
	init_local();
}
