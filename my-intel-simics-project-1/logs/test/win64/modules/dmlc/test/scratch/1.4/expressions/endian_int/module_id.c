...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860394" ";"
	"MOD:" "dml-test-endian_int" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:34 2025";
extern void _initialize_T_endian_int(void);
