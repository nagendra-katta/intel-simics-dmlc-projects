...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860461" ";"
	"MOD:" "dml-test-traitrefs_in_shared_sigs" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:41 2025";
extern void _initialize_T_traitrefs_in_shared_sigs(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_traitrefs_in_shared_sigs();
	init_local();
}
