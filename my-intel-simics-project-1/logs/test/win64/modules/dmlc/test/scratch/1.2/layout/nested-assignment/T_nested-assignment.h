...
#ifndef T_NESTED_ASSIGNMENT_H
#define T_NESTED_ASSIGNMENT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\layout\\nested-assignment\\T_nested-assignment.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_nested-assignment-struct.h"

typedef _traitref_t object;
typedef struct inner64 inner64;
typedef struct inner128 inner128;
typedef struct outer outer;
typedef struct t_deeply_nested t_deeply_nested;
struct inner64 {
    uint32_be_t a;
    uint32_be_t b;
};
...
struct _anon_struct_1 {
    struct _anon_struct_0 p2[2];
    uint8_be_t b;
};

struct t_deeply_nested {
    struct _anon_struct_1 p1;
};
...
#endif /* not T_NESTED_ASSIGNMENT_H */
