...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860344" ";"
	"MOD:" "dml-test-header_comment_3" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:44 2025";
extern void _initialize_T_header_comment_3(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_header_comment_3();
	init_local();
}
