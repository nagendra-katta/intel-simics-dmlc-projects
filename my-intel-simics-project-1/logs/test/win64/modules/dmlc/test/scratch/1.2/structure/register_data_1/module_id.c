...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860325" ";"
	"MOD:" "dml-test-register_data_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:25 2025";
extern void _initialize_T_register_data_1(void);
