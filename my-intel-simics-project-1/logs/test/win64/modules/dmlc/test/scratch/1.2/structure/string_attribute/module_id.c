...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860327" ";"
	"MOD:" "dml-test-string_attribute" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:27 2025";
extern void _initialize_T_string_attribute(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_string_attribute();
	init_local();
}
