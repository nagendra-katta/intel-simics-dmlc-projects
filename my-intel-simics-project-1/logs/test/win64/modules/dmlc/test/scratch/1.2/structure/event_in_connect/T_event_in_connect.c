 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\structure\T_event_in_connect.dml
...
#include "T_event_in_connect.h"
#include "T_event_in_connect-protos.c"
...
static set_error_t set_C(conf_object_t *_obj, attr_value_t *_val, lang_void *_aux)
{
        ...
        #line 1686 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
        {
            ...
            #line 1744 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
            {
                ...
                if (v27_obj != NULL)
                {
                    #line 1794 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                    if (v27_port != NULL)
                    _dev->C.signal = SIM_c_get_port_interface(v27_obj, "signal", v27_port);
                    else
                    _dev->C.signal = SIM_c_get_interface(v27_obj, "signal");
                    #line 1794 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                }
                #line 1798 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
                else
    ...
    #line 220 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\structure\\event_in_connect\\T_event_in_connect.c"
    return _status;
}
...
static void  _DML_EV_C__E__callback(conf_object_t *_obj, void  *param)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    if (_DML_M_C__E__callback(_dev, param))
    SIM_LOG_ERROR(&_dev->obj, 0, "Uncaught DML exception");
}

static void  _DML_EV_C__E__destroy(conf_object_t *_obj, void  *data)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    if (_DML_M_C__E__destroy(_dev, data))
    SIM_LOG_ERROR(&_dev->obj, 0, "Uncaught DML exception");
}

static attr_value_t _DML_EV_C__E__get_event_info(conf_object_t *_obj, void  *data)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    attr_value_t info;
    memset((void *)&info, 0, sizeof(attr_value_t ));
    {
        attr_value_t v53__ret_info UNUSED ;
        memset((void *)&v53__ret_info, 0, sizeof(attr_value_t ));
        if (_DML_M_C__E__get_event_info(_dev, data, &v53__ret_info))
        SIM_LOG_ERROR(&_dev->obj, 0, "Uncaught DML exception");
        info = v53__ret_info;
    }
    return info;
...
static void  *_DML_EV_C__E__set_event_info(conf_object_t *_obj, attr_value_t info)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    void  *data = NULL;
    {
        void  *v54__ret_data UNUSED  = NULL;
        if (_DML_M_C__E__set_event_info(_dev, info, &v54__ret_data))
        SIM_LOG_ERROR(&_dev->obj, 0, "Uncaught DML exception");
        data = v54__ret_data;
    }
    return data;
...
static char *_DML_EV_C__E__describe_event(conf_object_t *_obj, void  *data)
{
    test_t *_dev UNUSED = (test_t*)_obj;
    char *description = NULL;
    {
        char *v55__ret_description UNUSED  = NULL;
        if (_DML_M_C__E__describe_event(_dev, data, &v55__ret_description))
        SIM_LOG_ERROR(&_dev->obj, 0, "Uncaught DML exception");
        description = v55__ret_description;
    }
    return description;
}
...
static void * const _object_vtables[4] UNUSED = {(&_tr__dev__object), (&_tr_C_E__object), (&_tr_C_signal__object), (&_tr_C__object)};
...
/* C.E.set_event_info */
static bool _DML_M_C__E__set_event_info(test_t *_dev, attr_value_t info, void  **data)
#line 1830 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1830 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    void  *v60_data UNUSED  = NULL;
...
/* C.E.get_event_info */
static bool _DML_M_C__E__get_event_info(test_t *_dev, void  *data, attr_value_t *info)
#line 1822 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1822 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    attr_value_t v63_info UNUSED ;
    #line 1822 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    memset((void *)&v63_info, 0, sizeof(attr_value_t ));
    if (data != (NULL))
    SIM_LOG_ERROR(&_dev->obj, 0, "C.E.get_event_info(): Don't know how to handle non-NULL event data");
    #line 1827 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    v63_info = SIM_make_attr_nil();
    *info = v63_info;
    #line 1828 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
    #line 1828 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
/* C.E.destroy */
static bool _DML_M_C__E__destroy(test_t *_dev, void  *data)
#line 1837 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    return 0;
    #line 1838 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
/* C.E.describe_event */
static bool _DML_M_C__E__describe_event(test_t *_dev, void  *data, char **description)
#line 1815 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1815 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    char *v67_description UNUSED  = NULL;
    #line 1819 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    v67_description = MM_STRDUP("C.E");
    *description = v67_description;
    #line 1820 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
    #line 1820 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
}
...
/* C.E.callback */
static bool _DML_M_C__E__callback(test_t *_dev, void  *param)
#line 1969 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1982 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
...
conf_class_t *
_initialize_T_event_in_connect(void)
{
    ...
    _DML_register_attribute(class, "C", get_C, NULL, set_C, NULL, Sim_Attr_Optional|Sim_Attr_Internal, "o|[os]|n", "Undocumented\012\012Required interfaces: <iface>signal</iface>.");
...
{
    _send_now_evclass_2 = SIM_register_event("C.E", class, 0, _DML_EV_C__E__callback, _DML_EV_C__E__destroy, _DML_EV_C__E__get_event_info, _DML_EV_C__E__set_event_info, _DML_EV_C__E__describe_event);
}
...
static UNUSED bool C__E__callback(test_t *_dev, void  *param)
{
    return _DML_M_C__E__callback(_dev, param);
}
static UNUSED bool C__E__describe_event(test_t *_dev, void  *data, char **description)
{
    return _DML_M_C__E__describe_event(_dev, data, description);
}
static UNUSED bool C__E__destroy(test_t *_dev, void  *data)
{
    return _DML_M_C__E__destroy(_dev, data);
}
static UNUSED bool C__E__get_event_info(test_t *_dev, void  *data, attr_value_t *info)
{
    return _DML_M_C__E__get_event_info(_dev, data, info);
}
static UNUSED bool C__E__set_event_info(test_t *_dev, attr_value_t info, void  **data)
{
    return _DML_M_C__E__set_event_info(_dev, info, data);
}
