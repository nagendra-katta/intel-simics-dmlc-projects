...
#ifndef T_1_4_DEVINFO_GENERATE_H
#define T_1_4_DEVINFO_GENERATE_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4-devinfo-generate\\T_1.4-devinfo-generate.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_1.4-devinfo-generate-struct.h"
...
struct __devstruct_0test_0b_0r1 {
    uint64 val[4LL][2LL][2LL];
};
struct __devstruct_0test_0b_0rma {
    uint64 val[4LL][2LL][3LL][3LL];
};
struct __devstruct_0test_0b_0ru {
    uint64 val[4LL][2LL][3LL];
};
struct __devstruct_0test_0b {
    conf_object_t *_obj[4LL][2LL];
    _callback_vect_t _after_read_callbacks[4LL][2LL];
    _callback_vect_t _after_write_callbacks[4LL][2LL];
    _callback_vect_t _before_read_callbacks[4LL][2LL];
    _callback_vect_t _before_write_callbacks[4LL][2LL];
    conf_object_t *_cached_bank_obj[4LL][2LL];
    _connection_vect_t _connections[4LL][2LL];
    struct __devstruct_0test_0b_0r0 r0;
    struct __devstruct_0test_0b_0r1 r1;
    struct __devstruct_0test_0b_0rma rma;
    struct __devstruct_0test_0b_0ru ru;
};
struct test {
    conf_object_t obj;
...
#endif /* not T_1_4_DEVINFO_GENERATE_H */
