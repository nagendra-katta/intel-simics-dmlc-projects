...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860396" ";"
	"MOD:" "dml-test-illegal_arithmetic" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:36 2025";
extern void _initialize_T_illegal_arithmetic(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_illegal_arithmetic();
	init_local();
}
