 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\syntax\T_ident.dml
...
#include "T_ident.h"
#include "T_ident-protos.c"

static conf_object_t *
x_alloc(conf_class_t *cls)
{
    x_t *_dev = MM_ZALLOC(1, x_t);
    _dev->_immediate_after_state = MM_ZALLOC(1, _dml_immediate_after_state_t);
    return &_dev->obj;
}

static lang_void *
x_init(conf_object_t *_obj)
{
    x_t *_dev = (x_t*)_obj;
    ...
    return 0;
    SIM_add_notifier(_obj, Sim_Notify_Object_Delete, _obj, x_pre_delete, NULL);
    return _obj;
}

static void x_finalize(conf_object_t *_obj)
{
    x_t *_dev UNUSED = (x_t *)_obj;
}

static void x_objects_finalized(conf_object_t *_obj)
{
    x_t *_dev UNUSED = (x_t *)_obj;
...
static void x_pre_delete(conf_object_t *_subscriber, conf_object_t *_obj, lang_void *_data)
{
    x_t *_dev = (x_t *)_obj;
...
static void x_deinit(conf_object_t *_obj)
{
    x_t *_dev UNUSED = (x_t *)_obj;
    _DML_execute_immediate_afters_now(_obj, _dev->_immediate_after_state);
...
static void x_dealloc(conf_object_t *dev)
{
    MM_FREE(dev);
}
...
static void _init_data_objs(x_t *_dev)
{
    #line 274 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    _dev->_has_state_callbacks = 0;
    #line 161 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\syntax\\ident\\T_ident.c"
    #line 273 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
...
/* init */
static bool _DML_M_init(x_t *_dev)
#line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_ident.dml"
{
    #line 11 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_ident.dml"
    {
        int v14_attribute UNUSED  = 0;
        int v14_bank UNUSED  = 0;
        int v14_bitorder UNUSED  = 0;
        int v14_connect UNUSED  = 0;
        int v14_constant UNUSED  = 0;
        int v14_data UNUSED  = 0;
        int v14_device UNUSED  = 0;
        int v14_event UNUSED  = 0;
        int v14_field UNUSED  = 0;
        int v14_footer UNUSED  = 0;
        int v14_group UNUSED  = 0;
        int v14_header UNUSED  = 0;
        int v14_implement UNUSED  = 0;
        int v14_import UNUSED  = 0;
        int v14_interface UNUSED  = 0;
        int v14_loggroup UNUSED  = 0;
        int v14_method UNUSED  = 0;
        int v14_nothrow UNUSED  = 0;
        int v14_port UNUSED  = 0;
        int v14_size UNUSED  = 0;
        int v14_throws UNUSED  = 0;
    }
    #line 33 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_ident.dml"
    return 0;
    #line 33 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\syntax\\\\T_ident.dml"
...
/* soft_reset */
static bool _DML_M_soft_reset(x_t *_dev)
#line 1216 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1218 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
...
/* hard_reset */
static bool _DML_M_hard_reset(x_t *_dev)
#line 1211 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
{
    #line 1213 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\win64\\\\bin\\\\dml\\\\1.2\\\\dml-builtins.dml"
    return 0;
...
_initialize_T_ident(void)
{
    ...
    const class_info_t funcs = {
        ...
        .init = x_init,
        .finalize = x_finalize,
        .objects_finalized = x_objects_finalized,
        .dealloc = x_dealloc,
        .description = "x device",
    };

    conf_class_t *class = SIM_create_class("x", &funcs);
    _dev_class = class;
    if (SIM_clear_exception() != SimExc_No_Exception) {
        fprintf(stderr, "Failed to register class x: %s\n", SIM_last_error());
        return NULL;
    }
...
{
    ht_insert_str(&_id_info_ht, "x", &_id_infos[0]);
...
static void _init_port_objs(x_t *_dev)
{
}
static void _init_static_vars(x_t *_dev)
{
}

// DML serialization functions
static UNUSED bool hard_reset(x_t *_dev)
{
    return _DML_M_hard_reset(_dev);
}
static UNUSED bool soft_reset(x_t *_dev)
{
