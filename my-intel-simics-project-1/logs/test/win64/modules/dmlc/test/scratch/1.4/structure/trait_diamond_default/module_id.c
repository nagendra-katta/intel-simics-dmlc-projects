...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860514" ";"
	"MOD:" "dml-test-trait_diamond_default" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:34 2025";
extern void _initialize_T_trait_diamond_default(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_trait_diamond_default();
	init_local();
}
