...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860261" ";"
	"MOD:" "dml-test-bitfields_member_sign" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:21 2025";
extern void _initialize_T_bitfields_member_sign(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_bitfields_member_sign();
	init_local();
}
