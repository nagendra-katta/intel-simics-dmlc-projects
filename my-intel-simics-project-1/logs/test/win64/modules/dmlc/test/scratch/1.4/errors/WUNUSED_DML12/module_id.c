...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860393" ";"
	"MOD:" "dml-test-WUNUSED_DML12" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:33 2025";
extern void _initialize_T_WUNUSED_DML12(void);
