...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\expressions\\endian_int\\T_endian_int.h"
...
#define DMLDIR_T_ENDIAN_INT_H "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\modules\\dmlc\\test\\1.4\\expressions\\T_endian_int.h"
...
typedef _traitref_t use_typed_endianint_parameters;
...
struct _use_typed_endianint_parameters {
    int64_be_t *typed_int64_be_t;
    uint64_le_t *typed_uint64_le_t;
    uint8_le_t *typed_uint8_le_t;
    int8_le_t *typed_int8_le_t;
    bool (*s_m_t)(test_t *arg0, use_typed_endianint_parameters arg1, int arg2);
    int (*s_m)(test_t *arg0, use_typed_endianint_parameters arg1, int arg2);
};
struct _name {
    char const **name;
};
...
struct test {
    conf_object_t obj;
    int32_be_t static0_int32_be_t_session;
    uint16_le_t static1_uint16_le_t_session;
