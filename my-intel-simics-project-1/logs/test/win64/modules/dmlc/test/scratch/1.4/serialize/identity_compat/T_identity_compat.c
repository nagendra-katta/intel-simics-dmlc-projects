 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.4\serialize\T_identity_compat.dml
...
#include "T_identity_compat.h"
#include "T_identity_compat-protos.c"
static void
...
test_init(conf_object_t *_obj)
{
    ...
    #line 111 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\identity_compat\\T_identity_compat.c"
...
conf_class_t *
_initialize_T_identity_compat(void)
{
    ...
    _register_events(class);
    {
        ...
        static const _saved_userdata_t saved_userdata[1] = {
            {offsetof(test_t, s), 0, NULL, NULL, DML_deserialize_Tobject, DML_serialize_T},
        };
