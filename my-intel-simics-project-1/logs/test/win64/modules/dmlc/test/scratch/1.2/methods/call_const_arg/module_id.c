...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860228" ";"
	"MOD:" "dml-test-call_const_arg" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:48 2025";
extern void _initialize_T_call_const_arg(void);
