...
#ifndef T_SPLIT_OUTPUT_H
#define T_SPLIT_OUTPUT_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\misc\\split_output\\T_split_output.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_split_output-struct.h"

typedef _traitref_t t;
typedef _traitref_t object;
typedef struct x_interface_t x_interface_t;
struct x_interface_t {
    void  (*fun)();
};
