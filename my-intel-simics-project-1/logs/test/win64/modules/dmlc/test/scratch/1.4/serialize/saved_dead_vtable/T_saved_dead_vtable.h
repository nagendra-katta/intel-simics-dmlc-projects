...
#ifndef T_SAVED_DEAD_VTABLE_H
#define T_SAVED_DEAD_VTABLE_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\serialize\\saved_dead_vtable\\T_saved_dead_vtable.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_saved_dead_vtable-struct.h"

typedef _traitref_t t;
typedef _traitref_t u;
typedef _traitref_t uninstantiated_1;
typedef _traitref_t uninstantiated_2;
...
struct _t {
    void  (*m)(test_t *arg0, t arg1);
};
struct _u {
    void  (*n)(test_t *arg0, u arg1);
};
struct _uninstantiated_1 {
    void  (*o)(test_t *arg0, uninstantiated_1 arg1);
};
struct _uninstantiated_2 {
    void  (*p)(test_t *arg0, uninstantiated_2 arg1);
};
struct _name {
    char const **name;
};
...
struct test {
    conf_object_t obj;
    u static0_method_saved;
    uninstantiated_2 static1_method_saved_uninstantiated;
    ...
    t object_saved;
    uninstantiated_1 object_saved_uninstantiated;
};
...
#endif /* not T_SAVED_DEAD_VTABLE_H */
