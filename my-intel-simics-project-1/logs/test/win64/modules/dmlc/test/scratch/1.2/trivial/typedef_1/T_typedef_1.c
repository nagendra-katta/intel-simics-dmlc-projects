...
#include "T_typedef_1.h"
#include "T_typedef_1-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 122 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\trivial\\typedef_1\\T_typedef_1.c"
    _val0 = v3_value;
    return _val0;
}
