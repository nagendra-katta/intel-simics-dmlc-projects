...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860316" ";"
	"MOD:" "dml-test-connects_in_port_array" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:16 2025";
extern void _initialize_T_connects_in_port_array(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_connects_in_port_array();
	init_local();
}
