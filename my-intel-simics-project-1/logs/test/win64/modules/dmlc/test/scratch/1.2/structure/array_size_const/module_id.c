...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860308" ";"
	"MOD:" "dml-test-array_size_const" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:08 2025";
extern void _initialize_T_array_size_const(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_array_size_const();
	init_local();
}
