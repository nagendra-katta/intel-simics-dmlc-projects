...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\event\\T_event.h"
...
struct __devstruct_0test_2custom_cycle_destroyed {
    int64 val;
};
struct __devstruct_0test_2custom_cycle_happened {
    int64 val;
};
struct __devstruct_0test_2custom_time_destroyed {
    int64 val;
};
struct __devstruct_0test_2custom_time_happened {
    int64 val;
};
struct __devstruct_0test_2int_cycle_happened {
    uint64 val;
};
struct __devstruct_0test_2int_time_happened {
    uint64 val;
};
struct __devstruct_0test_0p_2simple_time_happened {
    int64 val;
};
struct __devstruct_0test_0p {
    conf_object_t *_obj;
    conf_object_t *_cached_port_obj;
    struct __devstruct_0test_0p_2simple_time_happened simple_time_happened;
};
struct __devstruct_0test_2simple_cycle_happened {
    int64 val;
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_2custom_cycle_destroyed custom_cycle_destroyed;
    struct __devstruct_0test_2custom_cycle_happened custom_cycle_happened;
    struct __devstruct_0test_2custom_time_destroyed custom_time_destroyed;
    struct __devstruct_0test_2custom_time_happened custom_time_happened;
    struct __devstruct_0test_2int_cycle_happened int_cycle_happened;
    struct __devstruct_0test_2int_time_happened int_time_happened;
    struct __devstruct_0test_0p p;
    struct __devstruct_0test_2simple_cycle_happened simple_cycle_happened;
};
