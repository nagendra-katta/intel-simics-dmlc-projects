...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860423" ";"
	"MOD:" "dml-test-port_proxy_ifaces_disabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:03 2025";
extern void _initialize_T_port_proxy_ifaces_disabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_port_proxy_ifaces_disabled();
	init_local();
}
