...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860343" ";"
	"MOD:" "dml-test-header_comment_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:43 2025";
extern void _initialize_T_header_comment_1(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_header_comment_1();
	init_local();
}
