...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860395" ";"
	"MOD:" "dml-test-each_in" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:35 2025";
extern void _initialize_T_each_in(void);
