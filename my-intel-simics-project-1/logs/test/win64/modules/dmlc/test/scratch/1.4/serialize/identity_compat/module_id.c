...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860485" ";"
	"MOD:" "dml-test-identity_compat" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:05 2025";
extern void _initialize_T_identity_compat(void);
