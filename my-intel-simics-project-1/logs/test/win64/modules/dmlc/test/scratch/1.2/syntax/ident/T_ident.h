...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\syntax\\ident\\T_ident.h"
...
// which saves space
STATIC_ASSERT(sizeof(struct x) <= UINT32_MAX);
static const uint64 Register_Read UNUSED = 1ULL;
static const uint64 Register_Write UNUSED = 2ULL;

void hard_reset_x(x_t *_obj);
void soft_reset_x(x_t *_obj);
