...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860430" ";"
	"MOD:" "dml-test-bad_subobj_connect" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:10 2025";
extern void _initialize_T_bad_subobj_connect(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_bad_subobj_connect();
	init_local();
}
