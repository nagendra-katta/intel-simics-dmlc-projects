...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860429" ";"
	"MOD:" "dml-test-warning_statement_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:09 2025";
extern void _initialize_T_warning_statement_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_warning_statement_enabled();
	init_local();
}
