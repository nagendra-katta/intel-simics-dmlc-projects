...
#ifndef T_MEMBER_REF_H
#define T_MEMBER_REF_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\layout\\member_ref\\T_member_ref.h"
...
typedef struct be_l be_l;
typedef struct le_l le_l;
struct be_l {
    uint24_be_t m;
    uint56_be_t a[2LL];
    uint16_be_t b;
