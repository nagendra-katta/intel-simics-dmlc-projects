...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860243" ";"
	"MOD:" "dml-test-array_set_4" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:03 2025";
extern void _initialize_T_array_set_4(void);
