...
#ifndef T_INSTRUMENTATION_TRANSACTION_H
#define T_INSTRUMENTATION_TRANSACTION_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\registers\\instrumentation_transaction\\T_instrumentation_transaction.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_instrumentation_transaction-struct.h"
...
struct __devstruct_0test_0b1_0R1 {
    uint64 val;
};
struct __devstruct_0test_0b1_0R2 {
    uint64 val;
};
struct __devstruct_0test_0b1_0R3 {
    uint64 val;
};
struct __devstruct_0test_0b1_0edge {
    uint64 val;
};
struct __devstruct_0test_0b1 {
    ...
    struct __devstruct_0test_0b1_0R1 R1;
    struct __devstruct_0test_0b1_0R2 R2;
    struct __devstruct_0test_0b1_0R3 R3;
    struct __devstruct_0test_0b1_0edge edge;
};
...
struct __devstruct_0test_0b2_0R6 {
    uint64 val;
};
...
struct __devstruct_0test_0b2 {
    ...
    struct __devstruct_0test_0b2_0R6 R6;
...
struct __devstruct_0test_0be_0R1 {
    uint64 val;
};
struct __devstruct_0test_0be_0R2 {
    uint64 val;
};
struct __devstruct_0test_0be {
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0be_0R1 R1;
    struct __devstruct_0test_0be_0R2 R2;
};
struct __devstruct_0test_0le_0R1 {
    uint64 val;
};
struct __devstruct_0test_0le_0R2 {
    uint64 val;
};
struct __devstruct_0test_0le {
    ...
    conf_object_t *_cached_bank_obj;
    _connection_vect_t _connections;
    struct __devstruct_0test_0le_0R1 R1;
    struct __devstruct_0test_0le_0R2 R2;
};
struct test {
    conf_object_t obj;
...
#endif /* not T_INSTRUMENTATION_TRANSACTION_H */
