...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860235" ";"
	"MOD:" "dml-test-inline_ignored_arg" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:53:55 2025";
extern void _initialize_T_inline_ignored_arg(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_inline_ignored_arg();
	init_local();
}
