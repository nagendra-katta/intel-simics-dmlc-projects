...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860275" ";"
	"MOD:" "dml-test-slice_bool" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:35 2025";
extern void _initialize_T_slice_bool(void);
