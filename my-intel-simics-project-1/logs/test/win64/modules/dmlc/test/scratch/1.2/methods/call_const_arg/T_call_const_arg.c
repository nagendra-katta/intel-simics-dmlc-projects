 ...
 *
 * Source files:
 *   C:\Users\nagen\simics-projects\my-intel-simics-project-1\modules\dmlc\test\1.2\methods\T_call_const_arg.dml
...
#include "T_call_const_arg.h"
#include "T_call_const_arg-protos.c"
...
static attr_value_t get_runtest(conf_object_t *_obj, lang_void *_aux)
{
    ...
    #line 134 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\methods\\call_const_arg\\T_call_const_arg.c"
    _val0 = v3_value;
    return _val0;
}
...
/* m */
static bool _DML_M_m(test_t *_dev, int x)
#line 12 "C:\\\\Users\\\\nagen\\\\simics-projects\\\\my-intel-simics-project-1\\\\modules\\\\dmlc\\\\test\\\\1.2\\\\methods\\\\T_call_const_arg.dml"
{
    x = 17;
    return 0;
...
conf_class_t *
_initialize_T_call_const_arg(void)
{
