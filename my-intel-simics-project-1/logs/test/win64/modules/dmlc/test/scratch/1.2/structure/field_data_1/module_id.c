...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860320" ";"
	"MOD:" "dml-test-field_data_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:20 2025";
extern void _initialize_T_field_data_1(void);
