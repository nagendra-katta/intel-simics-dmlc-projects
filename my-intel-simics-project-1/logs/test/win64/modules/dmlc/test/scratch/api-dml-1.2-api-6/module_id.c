...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860546" ";"
	"MOD:" "dml-test-api-dml-1.2-api-6" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:59:06 2025";
extern void _initialize_T_api_dml_1_2_api_6(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_api_dml_1_2_api_6();
	init_local();
}
