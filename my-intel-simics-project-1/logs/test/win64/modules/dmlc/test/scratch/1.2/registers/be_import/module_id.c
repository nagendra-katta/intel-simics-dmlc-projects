...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860279" ";"
	"MOD:" "dml-test-be_import" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:39 2025";
extern void _initialize_T_be_import(void);
