...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860330" ";"
	"MOD:" "dml-test-extern_func_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:30 2025";
extern void _initialize_T_extern_func_1(void);
