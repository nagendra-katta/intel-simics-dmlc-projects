...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860503" ";"
	"MOD:" "dml-test-diamond_override" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:58:23 2025";
extern void _initialize_T_diamond_override(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_diamond_override();
	init_local();
}
