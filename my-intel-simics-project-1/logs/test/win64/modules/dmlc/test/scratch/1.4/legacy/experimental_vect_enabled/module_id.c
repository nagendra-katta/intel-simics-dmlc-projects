...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860416" ";"
	"MOD:" "dml-test-experimental_vect_enabled" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:56 2025";
extern void _initialize_T_experimental_vect_enabled(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_experimental_vect_enabled();
	init_local();
}
