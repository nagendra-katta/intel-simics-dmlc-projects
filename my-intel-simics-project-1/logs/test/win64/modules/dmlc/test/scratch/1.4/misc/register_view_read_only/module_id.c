...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860478" ";"
	"MOD:" "dml-test-register_view_read_only" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:58 2025";
extern void _initialize_T_register_view_read_only(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_register_view_read_only();
	init_local();
}
