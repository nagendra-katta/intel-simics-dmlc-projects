...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860440" ";"
	"MOD:" "dml-test-byte_enable" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:20 2025";
extern void _initialize_T_byte_enable(void);
