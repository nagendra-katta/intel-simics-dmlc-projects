...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860264" ";"
	"MOD:" "dml-test-equal_1" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:24 2025";
extern void _initialize_T_equal_1(void);
