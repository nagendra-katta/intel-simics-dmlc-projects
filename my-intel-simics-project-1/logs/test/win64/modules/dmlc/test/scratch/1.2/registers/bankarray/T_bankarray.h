...
#ifndef T_BANKARRAY_H
#define T_BANKARRAY_H
...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.2\\registers\\bankarray\\T_bankarray.h"
...
struct __devstruct_0test_0regs_0g {
    uint32 gr[2][2];
    uint32 gra[2][2][2][2];
};
struct __devstruct_0test_0regs {
    conf_object_t *_obj[2];
    _callback_vect_t _after_read_callbacks[2];
    _callback_vect_t _after_write_callbacks[2];
    _callback_vect_t _before_read_callbacks[2];
    _callback_vect_t _before_write_callbacks[2];
    conf_object_t *_cached_bank_obj[2];
    _connection_vect_t _connections[2];
    struct __devstruct_0test_0regs_0g g;
    uint32 r[2];
    uint32 ra[2][2][2];
};
struct __devstruct_0test_0regs2 {
    conf_object_t *_obj[1];
    _callback_vect_t _after_read_callbacks[1];
    _callback_vect_t _after_write_callbacks[1];
    _callback_vect_t _before_read_callbacks[1];
    _callback_vect_t _before_write_callbacks[1];
    conf_object_t *_cached_bank_obj[1];
    _connection_vect_t _connections[1];
    uint8 r[1];
};
struct test {
    conf_object_t obj;
    ...
    struct __devstruct_0test_0regs2 regs2;
};
