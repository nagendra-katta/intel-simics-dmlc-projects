...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860284" ";"
	"MOD:" "dml-test-be_slice" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:44 2025";
extern void _initialize_T_be_slice(void);
