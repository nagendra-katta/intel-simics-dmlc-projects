...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860262" ";"
	"MOD:" "dml-test-utility_14_api" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:54:22 2025";
extern void _initialize_T_utility_14_api(void);
