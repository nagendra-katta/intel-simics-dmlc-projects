...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860401" ";"
	"MOD:" "dml-test-bad_hookattr_set" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:56:41 2025";
extern void _initialize_T_bad_hookattr_set(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_bad_hookattr_set();
	init_local();
}
