...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860451" ";"
	"MOD:" "dml-test-signal_templates" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:57:31 2025";
extern void _initialize_T_signal_templates(void);
...
_simics_module_init(void)
{
	...
	_initialize_T_signal_templates();
	init_local();
}
