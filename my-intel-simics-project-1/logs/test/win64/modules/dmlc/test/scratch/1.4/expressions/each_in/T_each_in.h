...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\expressions\\each_in\\T_each_in.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_each_in-struct.h"

typedef _traitref_t indirect;
typedef _traitref_t tr;
typedef _traitref_t t;
typedef _traitref_t t2;
typedef _traitref_t t3;
...
struct _tr {
    struct _indirect indirect;
    int (*m)(test_t *arg0, tr arg1);
};
struct _t {
    struct _tr tr;
};
