...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\expressions\\tqmic\\T_tqmic.h"
...
#include <simics/util/help-macros.h>
#include <stdint.h>
#include "T_tqmic-struct.h"

typedef _traitref_t t;
typedef _traitref_t u1;
typedef _traitref_t u2;
typedef _traitref_t u3;
typedef _traitref_t v;
typedef _traitref_t w;
...
struct _t {
    double (*sm)(test_t *arg0, t arg1);
    double (*m)(test_t *arg0, t arg1);
};
struct _u1 {
    struct _t t;
};
