...
#line 14 "C:\\Users\\nagen\\simics-projects\\my-intel-simics-project-1\\logs\\test\\win64\\modules\\dmlc\\test\\scratch\\1.4\\lib\\destroy\\T_destroy.h"
...
struct test {
    ...
    uint32 invocation_count;
    char const *invocations[4LL];
};
