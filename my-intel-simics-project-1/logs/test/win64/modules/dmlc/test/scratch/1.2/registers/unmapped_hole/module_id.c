...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1753860300" ";"
	"MOD:" "dml-test-unmapped_hole" ";"
	"CLS:test" ";"
	"HOSTTYPE:" "win64" ";"
	"PY_MINOR_VERSION:9;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Wed Jul 30 12:55:00 2025";
extern void _initialize_T_unmapped_hole(void);
